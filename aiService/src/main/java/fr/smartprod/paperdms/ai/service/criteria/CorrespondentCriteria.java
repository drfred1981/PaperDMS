...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.ai.domain.Correspondent} entity. This class is used
 * in {@link fr.smartprod.paperdms.ai.web.rest.CorrespondentResource} to receive all the possible filtering options from
