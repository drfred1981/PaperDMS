...
/**
 * Criteria class for the {@link com.ged.ai.domain.CorrespondentExtraction} entity. This class is used
 * in {@link com.ged.ai.web.rest.CorrespondentExtractionResource} to receive all the possible filtering options from
...
public class CorrespondentExtractionCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, documentId, status, startDate, endDate, sendersCount, recipientsCount, createdDate, distinct);
    }
