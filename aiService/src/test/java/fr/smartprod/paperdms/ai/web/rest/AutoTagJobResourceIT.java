...
class AutoTagJobResourceIT {
    ...
    void checkDocumentSha256IsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        autoTagJob.setDocumentSha256(null);
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDocumentSha256IsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where documentSha256 equals to
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDocumentSha256IsInShouldWork() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where documentSha256 in
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDocumentSha256IsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where documentSha256 is not null
        defaultAutoTagJobFiltering("documentSha256.specified=true", "documentSha256.specified=false");
    }

    @Test
    @Transactional
    void getAllAutoTagJobsByDocumentSha256ContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where documentSha256 contains
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDocumentSha256NotContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where documentSha256 does not contain
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByExtractedTextSha256IsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where extractedTextSha256 equals to
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByExtractedTextSha256IsInShouldWork() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where extractedTextSha256 in
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByExtractedTextSha256IsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where extractedTextSha256 is not null
        defaultAutoTagJobFiltering("extractedTextSha256.specified=true", "extractedTextSha256.specified=false");
    }

    @Test
    @Transactional
    void getAllAutoTagJobsByExtractedTextSha256ContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where extractedTextSha256 contains
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByExtractedTextSha256NotContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where extractedTextSha256 does not contain
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDetectedLanguageIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where detectedLanguage equals to
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDetectedLanguageIsInShouldWork() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where detectedLanguage in
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDetectedLanguageIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where detectedLanguage is not null
        defaultAutoTagJobFiltering("detectedLanguage.specified=true", "detectedLanguage.specified=false");
    }

    @Test
    @Transactional
    void getAllAutoTagJobsByDetectedLanguageContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where detectedLanguage contains
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByDetectedLanguageNotContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where detectedLanguage does not contain
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByLanguageConfidenceIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where languageConfidence equals to
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByLanguageConfidenceIsInShouldWork() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where languageConfidence in
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByLanguageConfidenceIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where languageConfidence is not null
        defaultAutoTagJobFiltering("languageConfidence.specified=true", "languageConfidence.specified=false");
    }

    @Test
    @Transactional
    void getAllAutoTagJobsByLanguageConfidenceIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where languageConfidence is greater than or equal to
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByLanguageConfidenceIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where languageConfidence is less than or equal to
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByLanguageConfidenceIsLessThanSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where languageConfidence is less than
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByLanguageConfidenceIsGreaterThanSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where languageConfidence is greater than
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByResultCacheKeyIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where resultCacheKey equals to
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByResultCacheKeyIsInShouldWork() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where resultCacheKey in
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByResultCacheKeyIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where resultCacheKey is not null
        defaultAutoTagJobFiltering("resultCacheKey.specified=true", "resultCacheKey.specified=false");
    }

    @Test
    @Transactional
    void getAllAutoTagJobsByResultCacheKeyContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where resultCacheKey contains
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByResultCacheKeyNotContainsSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where resultCacheKey does not contain
        defaultAutoTagJobFiltering(
    ...
    @Test
    @Transactional
    void getAllAutoTagJobsByIsCachedIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where isCached equals to
        defaultAutoTagJobFiltering("isCached.equals=" + DEFAULT_IS_CACHED, "isCached.equals=" + UPDATED_IS_CACHED);
    }

    @Test
    @Transactional
    void getAllAutoTagJobsByIsCachedIsInShouldWork() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where isCached in
        defaultAutoTagJobFiltering("isCached.in=" + DEFAULT_IS_CACHED + "," + UPDATED_IS_CACHED, "isCached.in=" + UPDATED_IS_CACHED);
    }

    @Test
    @Transactional
    void getAllAutoTagJobsByIsCachedIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedAutoTagJob = autoTagJobRepository.saveAndFlush(autoTagJob);

        // Get all the autoTagJobList where isCached is not null
        defaultAutoTagJobFiltering("isCached.specified=true", "isCached.specified=false");
    }
