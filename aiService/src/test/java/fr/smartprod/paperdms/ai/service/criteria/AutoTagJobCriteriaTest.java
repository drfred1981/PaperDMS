...
class AutoTagJobCriteriaTest {
    ...
    private static void setAllFilters(AutoTagJobCriteria autoTagJobCriteria) {
        ...
        autoTagJobCriteria.documentSha256();
        autoTagJobCriteria.s3Key();
        autoTagJobCriteria.extractedTextSha256();
        autoTagJobCriteria.detectedLanguage();
        autoTagJobCriteria.languageConfidence();
        autoTagJobCriteria.status();
        autoTagJobCriteria.modelVersion();
        autoTagJobCriteria.resultCacheKey();
        autoTagJobCriteria.isCached();
