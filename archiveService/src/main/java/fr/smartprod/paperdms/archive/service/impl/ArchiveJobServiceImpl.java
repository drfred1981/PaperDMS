...
public class ArchiveJobServiceImpl implements ArchiveJobService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ArchiveJobServiceImpl.class);

    private final ArchiveJobRepository archiveJobRepository;

    private final ArchiveJobMapper archiveJobMapper;

    public ArchiveJobServiceImpl(ArchiveJobRepository archiveJobRepository, ArchiveJobMapper archiveJobMapper) {
