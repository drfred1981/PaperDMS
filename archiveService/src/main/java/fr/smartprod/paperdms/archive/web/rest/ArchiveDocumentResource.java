...
public class ArchiveDocumentResource {
    ...
    public ArchiveDocumentResource(ArchiveDocumentService archiveDocumentService, ArchiveDocumentRepository archiveDocumentRepository) {
    ...
    public ResponseEntity<List<ArchiveDocumentDTO>> getAllArchiveDocuments(
        ...
        LOG.debug("REST request to get a page of ArchiveDocuments");
        Page<ArchiveDocumentDTO> page = archiveDocumentService.findAll(pageable);
