...
import { sampleWithRequiredData } from '../export-job.test-samples';
import { ExportJobService } from '../service/export-job.service';

import { ExportJobComponent } from './export-job.component';
import SpyInstance = jest.SpyInstance;

describe('ExportJob Management Component', () => {
  let comp: ExportJobComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ExportJobComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.exportJobs()[0]).toEqual(expect.objectContaining({ id: 4139 }));
  });

  describe('trackId', () => {
    it('should forward to exportJobService', () => {
      const entity = { id: 4139 };
      jest.spyOn(service, 'getExportJobIdentifier');
      const id = comp.trackId(entity);
      expect(service.getExportJobIdentifier).toHaveBeenCalledWith(entity);
