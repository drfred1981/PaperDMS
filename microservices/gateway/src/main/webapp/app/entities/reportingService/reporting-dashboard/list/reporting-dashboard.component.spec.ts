...
import { sampleWithRequiredData } from '../reporting-dashboard.test-samples';
...
describe('ReportingDashboard Management Component', () => {
  let comp: ReportingDashboardComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ReportingDashboardComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.reportingDashboards()[0]).toEqual(expect.objectContaining({ id: 5841 }));
  });

  describe('trackId', () => {
    it('should forward to reportingDashboardService', () => {
      const entity = { id: 5841 };
      jest.spyOn(service, 'getReportingDashboardIdentifier');
      const id = comp.trackId(entity);
      expect(service.getReportingDashboardIdentifier).toHaveBeenCalledWith(entity);
