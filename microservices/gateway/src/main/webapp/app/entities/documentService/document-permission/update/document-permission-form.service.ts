...
type DocumentPermissionFormGroupContent = {
  ...
  document: FormControl<DocumentPermissionFormRawValue['document']>;
  metaPermissionGroup: FormControl<DocumentPermissionFormRawValue['metaPermissionGroup']>;
};
...
export class DocumentPermissionFormService {
  createDocumentPermissionFormGroup(documentPermission: DocumentPermissionFormGroupInput = { id: null }): DocumentPermissionFormGroup {
    ...
    return new FormGroup<DocumentPermissionFormGroupContent>({
      ...
      document: new FormControl(documentPermissionRawValue.document),
      metaPermissionGroup: new FormControl(documentPermissionRawValue.metaPermissionGroup),
    });
  }
