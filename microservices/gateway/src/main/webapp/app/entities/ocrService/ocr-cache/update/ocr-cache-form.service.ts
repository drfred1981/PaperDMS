...
type OcrCacheFormGroupContent = {
  ...
  orcExtractedTextS3Key: FormControl<OcrCacheFormRawValue['orcExtractedTextS3Key']>;
...
export class OcrCacheFormService {
  createOcrCacheFormGroup(ocrCache: OcrCacheFormGroupInput = { id: null }): OcrCacheFormGroup {
    ...
    return new FormGroup<OcrCacheFormGroupContent>({
      ...
      orcExtractedTextS3Key: new FormControl(ocrCacheRawValue.orcExtractedTextS3Key, {
