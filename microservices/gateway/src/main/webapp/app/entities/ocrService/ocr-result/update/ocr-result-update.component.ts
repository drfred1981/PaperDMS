...
@Component({
  ...
  templateUrl: './ocr-result-update.component.html',
  imports: [SharedModule, FormsModule, ReactiveFormsModule],
})
export class OcrResultUpdateComponent implements OnInit {
  isSaving = false;
  ...
  protected updateForm(ocrResult: IOcrResult): void {
    ...
    this.ocrJobsSharedCollection = this.ocrJobService.addOcrJobToCollectionIfMissing<IOcrJob>(this.ocrJobsSharedCollection, ocrResult.job);
  }
