...
class DocumentCommentTest {
    ...
    void documentTest() {
        ...
        documentComment.setDocument(documentBack);
        assertThat(documentComment.getDocument()).isEqualTo(documentBack);

        documentComment.document(null);
        assertThat(documentComment.getDocument()).isNull();
    }
