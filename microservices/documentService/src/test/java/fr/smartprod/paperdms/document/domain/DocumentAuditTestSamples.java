...
public class DocumentAuditTestSamples {
    ...
    public static DocumentAudit getDocumentAuditSample1() {
        return new DocumentAudit().id(1L).documentSha256("documentSha2561").userId("userId1").userIp("userIp1");
    }

    public static DocumentAudit getDocumentAuditSample2() {
        return new DocumentAudit().id(2L).documentSha256("documentSha2562").userId("userId2").userIp("userIp2");
    }
