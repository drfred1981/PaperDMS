...
class DocumentCriteriaTest {
    ...
    private static void setAllFilters(DocumentCriteria documentCriteria) {
        ...
        documentCriteria.documentVersionsId();
        documentCriteria.documentTagsId();
        documentCriteria.statusesId();
        documentCriteria.documentExtractedFieldsId();
        documentCriteria.permissionsId();
        documentCriteria.auditsId();
        documentCriteria.commentsId();
        documentCriteria.metadatasId();
        documentCriteria.statisticsId();
    ...
    private static Condition<DocumentCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.gets3EMetaTag()) &&
                ...
                condition.apply(criteria.getDocumentVersionsId()) &&
                condition.apply(criteria.getDocumentTagsId()) &&
                condition.apply(criteria.getStatusesId()) &&
                condition.apply(criteria.getDocumentExtractedFieldsId()) &&
                condition.apply(criteria.getPermissionsId()) &&
                condition.apply(criteria.getAuditsId()) &&
                condition.apply(criteria.getCommentsId()) &&
                condition.apply(criteria.getMetadatasId()) &&
    ...
    private static Condition<DocumentCriteria> copyFiltersAre(DocumentCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.gets3EMetaTag(), copy.gets3EMetaTag()) &&
                ...
                condition.apply(criteria.getDocumentVersionsId(), copy.getDocumentVersionsId()) &&
                condition.apply(criteria.getDocumentTagsId(), copy.getDocumentTagsId()) &&
                condition.apply(criteria.getStatusesId(), copy.getStatusesId()) &&
                condition.apply(criteria.getDocumentExtractedFieldsId(), copy.getDocumentExtractedFieldsId()) &&
                condition.apply(criteria.getPermissionsId(), copy.getPermissionsId()) &&
                condition.apply(criteria.getAuditsId(), copy.getAuditsId()) &&
                condition.apply(criteria.getCommentsId(), copy.getCommentsId()) &&
                condition.apply(criteria.getMetadatasId(), copy.getMetadatasId()) &&
