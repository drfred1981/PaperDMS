...
class DocumentResourceIT {
    ...
    private static final String DEFAULT_S_3_E_META_TAG = "AAAAAAAAAA";
    private static final String UPDATED_S_3_E_META_TAG = "BBBBBBBBBB";
    ...
    public static Document createEntity() {
        return new Document()
            ...
            .s3EMetaTag(DEFAULT_S_3_E_META_TAG)
    ...
    public static Document createUpdatedEntity() {
        return new Document()
            ...
            .s3EMetaTag(UPDATED_S_3_E_META_TAG)
    ...
    void getAllDocuments() throws Exception {
        ...
        restDocumentMockMvc
            ...
            .andExpect(jsonPath("$.[*].s3EMetaTag").value(hasItem(DEFAULT_S_3_E_META_TAG)))
    ...
    void getDocument() throws Exception {
        ...
        restDocumentMockMvc
            ...
            .andExpect(jsonPath("$.s3EMetaTag").value(DEFAULT_S_3_E_META_TAG))
    ...
    @Test
    @Transactional
    void getAllDocumentsBys3EMetaTagIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedDocument = documentRepository.saveAndFlush(document);

        // Get all the documentList where s3EMetaTag equals to
        defaultDocumentFiltering("s3EMetaTag.equals=" + DEFAULT_S_3_E_META_TAG, "s3EMetaTag.equals=" + UPDATED_S_3_E_META_TAG);
    }

    @Test
    @Transactional
    void getAllDocumentsBys3EMetaTagIsInShouldWork() throws Exception {
        // Initialize the database
        insertedDocument = documentRepository.saveAndFlush(document);

        // Get all the documentList where s3EMetaTag in
        defaultDocumentFiltering(
            "s3EMetaTag.in=" + DEFAULT_S_3_E_META_TAG + "," + UPDATED_S_3_E_META_TAG,
            "s3EMetaTag.in=" + UPDATED_S_3_E_META_TAG
        );
    }

    @Test
    @Transactional
    void getAllDocumentsBys3EMetaTagIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedDocument = documentRepository.saveAndFlush(document);

        // Get all the documentList where s3EMetaTag is not null
        defaultDocumentFiltering("s3EMetaTag.specified=true", "s3EMetaTag.specified=false");
    }

    @Test
    @Transactional
    void getAllDocumentsBys3EMetaTagContainsSomething() throws Exception {
        // Initialize the database
        insertedDocument = documentRepository.saveAndFlush(document);

        // Get all the documentList where s3EMetaTag contains
        defaultDocumentFiltering("s3EMetaTag.contains=" + DEFAULT_S_3_E_META_TAG, "s3EMetaTag.contains=" + UPDATED_S_3_E_META_TAG);
    }

    @Test
    @Transactional
    void getAllDocumentsBys3EMetaTagNotContainsSomething() throws Exception {
        // Initialize the database
        insertedDocument = documentRepository.saveAndFlush(document);

        // Get all the documentList where s3EMetaTag does not contain
        defaultDocumentFiltering(
            "s3EMetaTag.doesNotContain=" + UPDATED_S_3_E_META_TAG,
            "s3EMetaTag.doesNotContain=" + DEFAULT_S_3_E_META_TAG
        );
    }
    ...
    void getAllDocumentsByFolderIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, MetaFolder.class).isEmpty()) {
            documentRepository.saveAndFlush(document);
            folder = MetaFolderResourceIT.createEntity();
        } else {
            folder = TestUtil.findAll(em, MetaFolder.class).get(0);
        }
        em.persist(folder);
        em.flush();
