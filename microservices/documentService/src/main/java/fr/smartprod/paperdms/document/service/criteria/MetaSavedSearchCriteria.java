...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.document.domain.MetaSavedSearch} entity. This class is used
 * in {@link fr.smartprod.paperdms.document.web.rest.MetaSavedSearchResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /meta-saved-searches?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MetaSavedSearchCriteria implements Serializable, Criteria {
    ...
    public MetaSavedSearchCriteria() {}

    public MetaSavedSearchCriteria(MetaSavedSearchCriteria other) {
    ...
    @Override
    public MetaSavedSearchCriteria copy() {
        return new MetaSavedSearchCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MetaSavedSearchCriteria that = (MetaSavedSearchCriteria) o;
        return (
    ...
    public String toString() {
        return "MetaSavedSearchCriteria{" +
