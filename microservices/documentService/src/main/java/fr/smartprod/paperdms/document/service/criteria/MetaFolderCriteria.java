...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.document.domain.MetaFolder} entity. This class is used
 * in {@link fr.smartprod.paperdms.document.web.rest.MetaFolderResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /meta-folders?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MetaFolderCriteria implements Serializable, Criteria {
    ...
    public MetaFolderCriteria() {}

    public MetaFolderCriteria(MetaFolderCriteria other) {
    ...
    @Override
    public MetaFolderCriteria copy() {
        return new MetaFolderCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MetaFolderCriteria that = (MetaFolderCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, path, isShared, createdDate, createdBy, childrenId, documentsId, parentId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "MetaFolderCriteria{" +
