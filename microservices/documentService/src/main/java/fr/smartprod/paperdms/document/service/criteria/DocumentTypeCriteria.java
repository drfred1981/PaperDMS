...
public class DocumentTypeCriteria implements Serializable, Criteria {
    ...
    private LongFilter documentTemplatesId;
    ...
    public DocumentTypeCriteria(DocumentTypeCriteria other) {
        ...
        this.documentTemplatesId = other.optionalDocumentTemplatesId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getDocumentTemplatesId() {
        return documentTemplatesId;
    }

    public Optional<LongFilter> optionalDocumentTemplatesId() {
        return Optional.ofNullable(documentTemplatesId);
    }

    public LongFilter documentTemplatesId() {
        if (documentTemplatesId == null) {
            setDocumentTemplatesId(new LongFilter());
        }
        return documentTemplatesId;
    }

    public void setDocumentTemplatesId(LongFilter documentTemplatesId) {
        this.documentTemplatesId = documentTemplatesId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(documentTemplatesId, that.documentTemplatesId) &&
    ...
    public String toString() {
        return "DocumentTypeCriteria{" +
            ...
            optionalDocumentTemplatesId().map(f -> "documentTemplatesId=" + f + ", ").orElse("") +
