...
public class DocumentPermissionDTO implements Serializable {
    ...
    private MetaPermissionGroupDTO metaPermissionGroup;
    ...
    public MetaPermissionGroupDTO getMetaPermissionGroup() {
        return metaPermissionGroup;
    }

    public void setMetaPermissionGroup(MetaPermissionGroupDTO metaPermissionGroup) {
    ...
    public String toString() {
        return "DocumentPermissionDTO{" +
            ...
            ", metaPermissionGroup=" + getMetaPermissionGroup() +
            "}";
    }
}
