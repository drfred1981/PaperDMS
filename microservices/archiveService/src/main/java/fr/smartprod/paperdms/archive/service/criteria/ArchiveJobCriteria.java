...
public class ArchiveJobCriteria implements Serializable, Criteria {
    ...
    private LongFilter archivesDocumentsId;
    ...
    public ArchiveJobCriteria(ArchiveJobCriteria other) {
        ...
        this.archivesDocumentsId = other.optionalArchivesDocumentsId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getArchivesDocumentsId() {
        return archivesDocumentsId;
    }

    public Optional<LongFilter> optionalArchivesDocumentsId() {
        return Optional.ofNullable(archivesDocumentsId);
    }

    public LongFilter archivesDocumentsId() {
        if (archivesDocumentsId == null) {
            setArchivesDocumentsId(new LongFilter());
        }
        return archivesDocumentsId;
    }

    public void setArchivesDocumentsId(LongFilter archivesDocumentsId) {
        this.archivesDocumentsId = archivesDocumentsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(archivesDocumentsId, that.archivesDocumentsId) &&
    ...
    public String toString() {
        return "ArchiveJobCriteria{" +
            ...
            optionalArchivesDocumentsId().map(f -> "archivesDocumentsId=" + f + ", ").orElse("") +
