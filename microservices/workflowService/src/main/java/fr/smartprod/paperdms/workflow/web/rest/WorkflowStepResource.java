...
import fr.smartprod.paperdms.workflow.service.WorkflowStepQueryService;
...
/**
 * REST controller for managing {@link fr.smartprod.paperdms.workflow.domain.WorkflowStep}.
 */
@RestController
...
public class WorkflowStepResource {
    ...
    /**
     * {@code SEARCH  /workflow-steps/_search?query=:query} : search for the workflowStep corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public ResponseEntity<List<WorkflowStepDTO>> searchWorkflowSteps(
