...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.ai.domain.AITagPrediction} entity. This class is used
 * in {@link fr.smartprod.paperdms.ai.web.rest.AITagPredictionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ai-tag-predictions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AITagPredictionCriteria implements Serializable, Criteria {
    ...
    public AITagPredictionCriteria() {}

    public AITagPredictionCriteria(AITagPredictionCriteria other) {
        this.id = other.optionalId().map(LongFilter::copy).orElse(null);
        this.tagName = other.optionalTagName().map(StringFilter::copy).orElse(null);
    ...
    @Override
    public AITagPredictionCriteria copy() {
        return new AITagPredictionCriteria(this);
    }
    ...
    public Optional<StringFilter> optionalTagName() {
        return Optional.ofNullable(tagName);
    }

    public StringFilter tagName() {
        if (tagName == null) {
            setTagName(new StringFilter());
        }
        return tagName;
    }
    ...
    public boolean equals(Object o) {
        ...
        final AITagPredictionCriteria that = (AITagPredictionCriteria) o;
        return (
    ...
    public String toString() {
        return "AITagPredictionCriteria{" +
            optionalId().map(f -> "id=" + f + ", ").orElse("") +
            optionalTagName().map(f -> "tagName=" + f + ", ").orElse("") +
