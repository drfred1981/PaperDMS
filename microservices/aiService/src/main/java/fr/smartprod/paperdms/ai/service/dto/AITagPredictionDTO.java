...
/**
 * A DTO for the {@link fr.smartprod.paperdms.ai.domain.AITagPrediction} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AITagPredictionDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AITagPredictionDTO)) {
            return false;
        }

        AITagPredictionDTO aITagPredictionDTO = (AITagPredictionDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, aITagPredictionDTO.id);
    }
