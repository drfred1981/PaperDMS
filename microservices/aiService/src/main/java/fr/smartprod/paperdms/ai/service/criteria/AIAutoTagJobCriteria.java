...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.ai.domain.AIAutoTagJob} entity. This class is used
 * in {@link fr.smartprod.paperdms.ai.web.rest.AIAutoTagJobResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ai-auto-tag-jobs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class AIAutoTagJobCriteria implements Serializable, Criteria {
    ...
    private LongFilter aITypePredictionId;

    private LongFilter languagePredictionId;

    private LongFilter aITagPredictionsId;

    private LongFilter aICorrespondentPredictionsId;

    private Boolean distinct;

    public AIAutoTagJobCriteria() {}

    public AIAutoTagJobCriteria(AIAutoTagJobCriteria other) {
        ...
        this.aITypePredictionId = other.optionalAITypePredictionId().map(LongFilter::copy).orElse(null);
        this.languagePredictionId = other.optionalLanguagePredictionId().map(LongFilter::copy).orElse(null);
        this.aITagPredictionsId = other.optionalAITagPredictionsId().map(LongFilter::copy).orElse(null);
        this.aICorrespondentPredictionsId = other.optionalAICorrespondentPredictionsId().map(LongFilter::copy).orElse(null);
        this.distinct = other.distinct;
    }

    @Override
    public AIAutoTagJobCriteria copy() {
        return new AIAutoTagJobCriteria(this);
    }
    ...
    public LongFilter getAITypePredictionId() {
        return aITypePredictionId;
    }

    public Optional<LongFilter> optionalAITypePredictionId() {
        return Optional.ofNullable(aITypePredictionId);
    }

    public LongFilter aITypePredictionId() {
        if (aITypePredictionId == null) {
            setAITypePredictionId(new LongFilter());
        }
        return aITypePredictionId;
    }

    public void setAITypePredictionId(LongFilter aITypePredictionId) {
        this.aITypePredictionId = aITypePredictionId;
    }

    public LongFilter getLanguagePredictionId() {
        return languagePredictionId;
    }

    public Optional<LongFilter> optionalLanguagePredictionId() {
        return Optional.ofNullable(languagePredictionId);
    }

    public LongFilter languagePredictionId() {
        if (languagePredictionId == null) {
            setLanguagePredictionId(new LongFilter());
        }
        return languagePredictionId;
    }

    public void setLanguagePredictionId(LongFilter languagePredictionId) {
        this.languagePredictionId = languagePredictionId;
    }

    public LongFilter getAITagPredictionsId() {
        return aITagPredictionsId;
    }

    public Optional<LongFilter> optionalAITagPredictionsId() {
        return Optional.ofNullable(aITagPredictionsId);
    }

    public LongFilter aITagPredictionsId() {
        if (aITagPredictionsId == null) {
            setAITagPredictionsId(new LongFilter());
        }
        return aITagPredictionsId;
    }

    public void setAITagPredictionsId(LongFilter aITagPredictionsId) {
        this.aITagPredictionsId = aITagPredictionsId;
    }

    public LongFilter getAICorrespondentPredictionsId() {
        return aICorrespondentPredictionsId;
    }

    public Optional<LongFilter> optionalAICorrespondentPredictionsId() {
        return Optional.ofNullable(aICorrespondentPredictionsId);
    }

    public LongFilter aICorrespondentPredictionsId() {
        if (aICorrespondentPredictionsId == null) {
            setAICorrespondentPredictionsId(new LongFilter());
        }
        return aICorrespondentPredictionsId;
    }

    public void setAICorrespondentPredictionsId(LongFilter aICorrespondentPredictionsId) {
        this.aICorrespondentPredictionsId = aICorrespondentPredictionsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final AIAutoTagJobCriteria that = (AIAutoTagJobCriteria) o;
        return (
            ...
            Objects.equals(aITypePredictionId, that.aITypePredictionId) &&
            Objects.equals(languagePredictionId, that.languagePredictionId) &&
            Objects.equals(aITagPredictionsId, that.aITagPredictionsId) &&
            Objects.equals(aICorrespondentPredictionsId, that.aICorrespondentPredictionsId) &&
    ...
    public int hashCode() {
        return Objects.hash(
            ...
            createdDate,
            aITypePredictionId,
            languagePredictionId,
            aITagPredictionsId,
            aICorrespondentPredictionsId,
            distinct
        );
    }
    ...
    public String toString() {
        return "AIAutoTagJobCriteria{" +
            ...
            optionalAITypePredictionId().map(f -> "aITypePredictionId=" + f + ", ").orElse("") +
            optionalLanguagePredictionId().map(f -> "languagePredictionId=" + f + ", ").orElse("") +
            optionalAITagPredictionsId().map(f -> "aITagPredictionsId=" + f + ", ").orElse("") +
            optionalAICorrespondentPredictionsId().map(f -> "aICorrespondentPredictionsId=" + f + ", ").orElse("") +
