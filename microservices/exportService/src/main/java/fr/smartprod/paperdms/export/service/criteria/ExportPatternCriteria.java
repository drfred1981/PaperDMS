...
public class ExportPatternCriteria implements Serializable, Criteria {
    ...
    private LongFilter exportJobsId;
    ...
    public ExportPatternCriteria(ExportPatternCriteria other) {
        ...
        this.exportJobsId = other.optionalExportJobsId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getExportJobsId() {
        return exportJobsId;
    }

    public Optional<LongFilter> optionalExportJobsId() {
        return Optional.ofNullable(exportJobsId);
    }

    public LongFilter exportJobsId() {
        if (exportJobsId == null) {
            setExportJobsId(new LongFilter());
        }
        return exportJobsId;
    }

    public void setExportJobsId(LongFilter exportJobsId) {
        this.exportJobsId = exportJobsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(exportJobsId, that.exportJobsId) &&
    ...
    public String toString() {
        return "ExportPatternCriteria{" +
            ...
            optionalExportJobsId().map(f -> "exportJobsId=" + f + ", ").orElse("") +
