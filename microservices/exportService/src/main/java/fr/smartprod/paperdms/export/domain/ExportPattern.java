...
public class ExportPattern implements Serializable {
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "exportPattern")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public void setExportJobs(Set<ExportJob> exportJobs) {
        if (this.exportJobs != null) {
            this.exportJobs.forEach(i -> i.setExportPattern(null));
        }
        if (exportJobs != null) {
            exportJobs.forEach(i -> i.setExportPattern(this));
        }
        this.exportJobs = exportJobs;
    }

    public ExportPattern exportJobs(Set<ExportJob> exportJobs) {
        this.setExportJobs(exportJobs);
        return this;
    }

    public ExportPattern addExportJobs(ExportJob exportJob) {
        this.exportJobs.add(exportJob);
        exportJob.setExportPattern(this);
        return this;
    }

    public ExportPattern removeExportJobs(ExportJob exportJob) {
        this.exportJobs.remove(exportJob);
        exportJob.setExportPattern(null);
        return this;
    }
