...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.search.domain.SearchQuery} entity. This class is used
 * in {@link fr.smartprod.paperdms.search.web.rest.SearchQueryResource} to receive all the possible filtering options from
...
public class SearchQueryCriteria implements Serializable, Criteria {
    ...
    public SearchQueryCriteria(SearchQueryCriteria other) {
        ...
        this.facetsId = other.optionalFacetsId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getFacetsId() {
        return facetsId;
    }

    public Optional<LongFilter> optionalFacetsId() {
        return Optional.ofNullable(facetsId);
    }

    public LongFilter facetsId() {
        if (facetsId == null) {
            setFacetsId(new LongFilter());
        }
        return facetsId;
    }

    public void setFacetsId(LongFilter facetsId) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(facetsId, that.facetsId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, query, resultCount, executionTime, userId, searchDate, isRelevant, facetsId, distinct);
    }
    ...
    public String toString() {
        return "SearchQueryCriteria{" +
            ...
            optionalFacetsId().map(f -> "facetsId=" + f + ", ").orElse("") +
