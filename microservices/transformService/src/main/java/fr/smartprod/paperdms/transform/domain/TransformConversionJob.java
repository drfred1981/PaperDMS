...
/**
 * A TransformConversionJob.
 */
@Entity
@Table(name = "transform_conversion_job")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TransformConversionJob implements Serializable {
    ...
    public TransformConversionJob id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public TransformConversionJob documentSha256(String documentSha256) {
    ...
    public TransformConversionJob sourceFormat(String sourceFormat) {
    ...
    public TransformConversionJob targetFormat(String targetFormat) {
    ...
    public TransformConversionJob conversionEngine(String conversionEngine) {
    ...
    public TransformConversionJob options(String options) {
    ...
    public TransformConversionJob outputS3Key(String outputS3Key) {
    ...
    public TransformConversionJob outputDocumentSha256(String outputDocumentSha256) {
    ...
    public TransformConversionJob status(TransformStatus status) {
    ...
    public TransformConversionJob startDate(Instant startDate) {
    ...
    public TransformConversionJob endDate(Instant endDate) {
    ...
    public TransformConversionJob errorMessage(String errorMessage) {
    ...
    public TransformConversionJob createdBy(String createdBy) {
    ...
    public TransformConversionJob createdDate(Instant createdDate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TransformConversionJob)) {
            return false;
        }
        return getId() != null && getId().equals(((TransformConversionJob) o).getId());
    }
