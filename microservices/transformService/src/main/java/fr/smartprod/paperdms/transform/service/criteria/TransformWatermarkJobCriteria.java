...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.transform.domain.TransformWatermarkJob} entity. This class is used
 * in {@link fr.smartprod.paperdms.transform.web.rest.TransformWatermarkJobResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /transform-watermark-jobs?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class TransformWatermarkJobCriteria implements Serializable, Criteria {
    ...
    public TransformWatermarkJobCriteria() {}

    public TransformWatermarkJobCriteria(TransformWatermarkJobCriteria other) {
    ...
    @Override
    public TransformWatermarkJobCriteria copy() {
        return new TransformWatermarkJobCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final TransformWatermarkJobCriteria that = (TransformWatermarkJobCriteria) o;
        return (
    ...
    public String toString() {
        return "TransformWatermarkJobCriteria{" +
