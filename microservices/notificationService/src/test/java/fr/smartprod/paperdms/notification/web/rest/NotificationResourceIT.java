...
import static fr.smartprod.paperdms.notification.domain.NotificationAsserts.*;
...
class NotificationResourceIT {
    ...
    private static final String DEFAULT_RELATED_ENTITY_NAME = "AAAAAAAAAA";
    private static final String UPDATED_RELATED_ENTITY_NAME = "BBBBBBBBBB";
    ...
    public static Notification createEntity() {
        return new Notification()
            ...
            .relatedEntityName(DEFAULT_RELATED_ENTITY_NAME)
    ...
    public static Notification createUpdatedEntity() {
        return new Notification()
            ...
            .relatedEntityName(UPDATED_RELATED_ENTITY_NAME)
    ...
    void getAllNotifications() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.[*].relatedEntityName").value(hasItem(DEFAULT_RELATED_ENTITY_NAME)))
    ...
    void getNotification() throws Exception {
        ...
        restNotificationMockMvc
            ...
            .andExpect(jsonPath("$.relatedEntityName").value(DEFAULT_RELATED_ENTITY_NAME))
    ...
    @Test
    @Transactional
    void getAllNotificationsByRelatedEntityNameIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedNotification = notificationRepository.saveAndFlush(notification);

        // Get all the notificationList where relatedEntityName equals to
        defaultNotificationFiltering(
            "relatedEntityName.equals=" + DEFAULT_RELATED_ENTITY_NAME,
            "relatedEntityName.equals=" + UPDATED_RELATED_ENTITY_NAME
        );
    }

    @Test
    @Transactional
    void getAllNotificationsByRelatedEntityNameIsInShouldWork() throws Exception {
        // Initialize the database
        insertedNotification = notificationRepository.saveAndFlush(notification);

        // Get all the notificationList where relatedEntityName in
        defaultNotificationFiltering(
            "relatedEntityName.in=" + DEFAULT_RELATED_ENTITY_NAME + "," + UPDATED_RELATED_ENTITY_NAME,
            "relatedEntityName.in=" + UPDATED_RELATED_ENTITY_NAME
        );
    }

    @Test
    @Transactional
    void getAllNotificationsByRelatedEntityNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedNotification = notificationRepository.saveAndFlush(notification);

        // Get all the notificationList where relatedEntityName is not null
        defaultNotificationFiltering("relatedEntityName.specified=true", "relatedEntityName.specified=false");
    }

    @Test
    @Transactional
    void getAllNotificationsByRelatedEntityNameContainsSomething() throws Exception {
        // Initialize the database
        insertedNotification = notificationRepository.saveAndFlush(notification);

        // Get all the notificationList where relatedEntityName contains
        defaultNotificationFiltering(
            "relatedEntityName.contains=" + DEFAULT_RELATED_ENTITY_NAME,
            "relatedEntityName.contains=" + UPDATED_RELATED_ENTITY_NAME
        );
    }

    @Test
    @Transactional
    void getAllNotificationsByRelatedEntityNameNotContainsSomething() throws Exception {
        // Initialize the database
        insertedNotification = notificationRepository.saveAndFlush(notification);

        // Get all the notificationList where relatedEntityName does not contain
        defaultNotificationFiltering(
            "relatedEntityName.doesNotContain=" + UPDATED_RELATED_ENTITY_NAME,
            "relatedEntityName.doesNotContain=" + DEFAULT_RELATED_ENTITY_NAME
        );
    }
