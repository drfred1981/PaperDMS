...
/**
 * A DTO for the {@link fr.smartprod.paperdms.notification.domain.NotificationWebhookSubscription} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NotificationWebhookSubscriptionDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NotificationWebhookSubscriptionDTO)) {
            return false;
        }

        NotificationWebhookSubscriptionDTO notificationWebhookSubscriptionDTO = (NotificationWebhookSubscriptionDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, notificationWebhookSubscriptionDTO.id);
    }
    ...
    public String toString() {
        return "NotificationWebhookSubscriptionDTO{" +
            "id=" + getId() +
            ", name='" + getName() + "'" +
            ", url='" + getUrl() + "'" +
            ", secret='" + getSecret() + "'" +
