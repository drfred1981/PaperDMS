...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.notification.domain.Notification} entity. This class is used
 * in {@link fr.smartprod.paperdms.notification.web.rest.NotificationResource} to receive all the possible filtering options from
...
public class NotificationCriteria implements Serializable, Criteria {
    ...
    private StringFilter relatedEntityName;
    ...
    public NotificationCriteria(NotificationCriteria other) {
        ...
        this.relatedEntityName = other.optionalRelatedEntityName().map(StringFilter::copy).orElse(null);
    ...
    public StringFilter getRelatedEntityName() {
        return relatedEntityName;
    }

    public Optional<StringFilter> optionalRelatedEntityName() {
        return Optional.ofNullable(relatedEntityName);
    }

    public StringFilter relatedEntityName() {
        if (relatedEntityName == null) {
            setRelatedEntityName(new StringFilter());
        }
        return relatedEntityName;
    }

    public void setRelatedEntityName(StringFilter relatedEntityName) {
    ...
    public String toString() {
        return "NotificationCriteria{" +
            ...
            optionalRelatedEntityName().map(f -> "relatedEntityName=" + f + ", ").orElse("") +
