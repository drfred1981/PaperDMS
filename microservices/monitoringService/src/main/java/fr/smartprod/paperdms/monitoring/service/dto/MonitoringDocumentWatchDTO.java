...
/**
 * A DTO for the {@link fr.smartprod.paperdms.monitoring.domain.MonitoringDocumentWatch} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MonitoringDocumentWatchDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MonitoringDocumentWatchDTO)) {
            return false;
        }

        MonitoringDocumentWatchDTO monitoringDocumentWatchDTO = (MonitoringDocumentWatchDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, monitoringDocumentWatchDTO.id);
    }
    ...
    public String toString() {
        return "MonitoringDocumentWatchDTO{" +
            "id=" + getId() +
