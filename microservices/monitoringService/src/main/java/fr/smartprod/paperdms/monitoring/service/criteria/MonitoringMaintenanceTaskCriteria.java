...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.monitoring.domain.MonitoringMaintenanceTask} entity. This class is used
 * in {@link fr.smartprod.paperdms.monitoring.web.rest.MonitoringMaintenanceTaskResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /monitoring-maintenance-tasks?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MonitoringMaintenanceTaskCriteria implements Serializable, Criteria {
    ...
    public MonitoringMaintenanceTaskCriteria() {}

    public MonitoringMaintenanceTaskCriteria(MonitoringMaintenanceTaskCriteria other) {
    ...
    @Override
    public MonitoringMaintenanceTaskCriteria copy() {
        return new MonitoringMaintenanceTaskCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MonitoringMaintenanceTaskCriteria that = (MonitoringMaintenanceTaskCriteria) o;
        return (
    ...
    public String toString() {
        return "MonitoringMaintenanceTaskCriteria{" +
