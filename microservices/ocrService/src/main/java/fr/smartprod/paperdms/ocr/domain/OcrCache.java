...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "ocrcache")
...
public class OcrCache implements Serializable {
    ...
    @Size(max = 1000)
    @Column(name = "orc_extracted_text_s_3_key", length = 1000)
    @org.springframework.data.elasticsearch.annotations.Field(type = org.springframework.data.elasticsearch.annotations.FieldType.Text)
    ...
    public String getOrcExtractedTextS3Key() {
        return this.orcExtractedTextS3Key;
    }

    public OcrCache orcExtractedTextS3Key(String orcExtractedTextS3Key) {
        this.setOrcExtractedTextS3Key(orcExtractedTextS3Key);
        return this;
    }
