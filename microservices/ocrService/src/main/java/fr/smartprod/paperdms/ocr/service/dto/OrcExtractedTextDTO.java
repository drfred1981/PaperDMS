...
/**
 * A DTO for the {@link fr.smartprod.paperdms.ocr.domain.OrcExtractedText} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OrcExtractedTextDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrcExtractedTextDTO)) {
            return false;
        }

        OrcExtractedTextDTO orcExtractedTextDTO = (OrcExtractedTextDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, orcExtractedTextDTO.id);
    }
