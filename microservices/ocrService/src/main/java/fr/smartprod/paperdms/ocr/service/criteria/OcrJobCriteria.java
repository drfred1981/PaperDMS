...
public class OcrJobCriteria implements Serializable, Criteria {
    ...
    private LongFilter extractedId;
    ...
    public OcrJobCriteria(OcrJobCriteria other) {
        ...
        this.extractedId = other.optionalExtractedId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getExtractedId() {
        return extractedId;
    }

    public Optional<LongFilter> optionalExtractedId() {
        return Optional.ofNullable(extractedId);
    }

    public LongFilter extractedId() {
        if (extractedId == null) {
            setExtractedId(new LongFilter());
        }
        return extractedId;
    }

    public void setExtractedId(LongFilter extractedId) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(extractedId, that.extractedId) &&
    ...
    public String toString() {
        return "OcrJobCriteria{" +
            ...
            optionalExtractedId().map(f -> "extractedId=" + f + ", ").orElse("") +
