...
public class BankTransactionAsserts {
    ...
    public static void assertBankTransactionUpdatableFieldsEquals(BankTransaction expected, BankTransaction actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getStatementId()).as("check statementId").isEqualTo(expected.getStatementId()))
            ...
            .satisfies(a -> assertThat(a.getDebitAmount()).as("check debitAmount").isEqualTo(expected.getDebitAmount()))
            .satisfies(a -> assertThat(a.getCreditAmount()).as("check creditAmount").isEqualTo(expected.getCreditAmount()))
