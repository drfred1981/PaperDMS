...
/**
 * REST controller for managing {@link fr.smartprod.paperdms.business.domain.InvoiceLine}.
 */
@RestController
...
public class InvoiceLineResource {
    ...
    private static final String ENTITY_NAME = "businessDocServiceInvoiceLine";
    ...
    public ResponseEntity<InvoiceLineDTO> createInvoiceLine(@Valid @RequestBody InvoiceLineDTO invoiceLineDTO) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/invoice-lines/" + invoiceLineDTO.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, invoiceLineDTO.getId().toString()))
            .body(invoiceLineDTO);
    }
    ...
    public ResponseEntity<InvoiceLineDTO> partialUpdateInvoiceLine(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, invoiceLineDTO.getId().toString())
        );
    }
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<InvoiceLineDTO>> getAllInvoiceLines(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
