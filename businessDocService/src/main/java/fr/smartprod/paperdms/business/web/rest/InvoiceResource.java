...
import fr.smartprod.paperdms.business.service.InvoiceQueryService;
...
/**
 * REST controller for managing {@link fr.smartprod.paperdms.business.domain.Invoice}.
 */
@RestController
...
public class InvoiceResource {
    ...
    /**
     * {@code SEARCH  /invoices/_search?query=:query} : search for the invoice corresponding
     * to the query.
     *
