...
class WorkflowCriteriaTest {
    ...
    private static void setAllFilters(WorkflowCriteria workflowCriteria) {
        ...
        workflowCriteria.workflowStpesId();
        workflowCriteria.workflowInstancesId();
    ...
    private static Condition<WorkflowCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getWorkflowStpesId()) &&
                condition.apply(criteria.getWorkflowInstancesId()) &&
    ...
    private static Condition<WorkflowCriteria> copyFiltersAre(WorkflowCriteria copy, BiFunction<Object, Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getWorkflowStpesId(), copy.getWorkflowStpesId()) &&
                condition.apply(criteria.getWorkflowInstancesId(), copy.getWorkflowInstancesId()) &&
