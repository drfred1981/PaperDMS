...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.workflow.domain.WorkflowTask} entity. This class is used
 * in {@link fr.smartprod.paperdms.workflow.web.rest.WorkflowTaskResource} to receive all the possible filtering options from
