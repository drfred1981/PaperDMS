...
import fr.smartprod.paperdms.workflow.service.WorkflowQueryService;
...
/**
 * REST controller for managing {@link fr.smartprod.paperdms.workflow.domain.Workflow}.
 */
@RestController
...
public class WorkflowResource {
    ...
    /**
     * {@code SEARCH  /workflows/_search?query=:query} : search for the workflow corresponding
     * to the query.
     *
     ...
     */
    @GetMapping("/_search")
    public ResponseEntity<List<WorkflowDTO>> searchWorkflows(
