...
public class WorkflowCriteria implements Serializable, Criteria {
    ...
    private LongFilter workflowStpesId;

    private LongFilter workflowInstancesId;
    ...
    public WorkflowCriteria(WorkflowCriteria other) {
        ...
        this.workflowStpesId = other.optionalWorkflowStpesId().map(LongFilter::copy).orElse(null);
        this.workflowInstancesId = other.optionalWorkflowInstancesId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getWorkflowStpesId() {
        return workflowStpesId;
    }

    public Optional<LongFilter> optionalWorkflowStpesId() {
        return Optional.ofNullable(workflowStpesId);
    }

    public LongFilter workflowStpesId() {
        if (workflowStpesId == null) {
            setWorkflowStpesId(new LongFilter());
        }
        return workflowStpesId;
    }

    public void setWorkflowStpesId(LongFilter workflowStpesId) {
        this.workflowStpesId = workflowStpesId;
    }

    public LongFilter getWorkflowInstancesId() {
        return workflowInstancesId;
    }

    public Optional<LongFilter> optionalWorkflowInstancesId() {
        return Optional.ofNullable(workflowInstancesId);
    }

    public LongFilter workflowInstancesId() {
        if (workflowInstancesId == null) {
            setWorkflowInstancesId(new LongFilter());
        }
        return workflowInstancesId;
    }

    public void setWorkflowInstancesId(LongFilter workflowInstancesId) {
        this.workflowInstancesId = workflowInstancesId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(workflowStpesId, that.workflowStpesId) &&
            Objects.equals(workflowInstancesId, that.workflowInstancesId) &&
    ...
    public String toString() {
        return "WorkflowCriteria{" +
            ...
            optionalWorkflowStpesId().map(f -> "workflowStpesId=" + f + ", ").orElse("") +
            optionalWorkflowInstancesId().map(f -> "workflowInstancesId=" + f + ", ").orElse("") +
