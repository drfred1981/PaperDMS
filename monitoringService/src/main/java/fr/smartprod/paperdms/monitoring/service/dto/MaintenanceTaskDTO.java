...
/**
 * A DTO for the {@link fr.smartprod.paperdms.monitoring.domain.MaintenanceTask} entity.
 */
...
public class MaintenanceTaskDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MaintenanceTaskDTO)) {
            return false;
        }

        MaintenanceTaskDTO maintenanceTaskDTO = (MaintenanceTaskDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, maintenanceTaskDTO.id);
    }
