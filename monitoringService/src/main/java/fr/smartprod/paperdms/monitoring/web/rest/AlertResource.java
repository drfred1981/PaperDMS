...
import fr.smartprod.paperdms.monitoring.service.AlertQueryService;
...
/**
 * REST controller for managing {@link fr.smartprod.paperdms.monitoring.domain.Alert}.
 */
@RestController
...
public class AlertResource {
    ...
    private static final String ENTITY_NAME = "monitoringServiceAlert";
    ...
    public ResponseEntity<AlertDTO> partialUpdateAlert(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody AlertDTO alertDTO
    ) throws URISyntaxException {
