...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.monitoring.domain.Alert} entity. This class is used
 * in {@link fr.smartprod.paperdms.monitoring.web.rest.AlertResource} to receive all the possible filtering options from
