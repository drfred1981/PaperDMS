...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.monitoring.domain.Alert}
 * entity. This class is used in
 * {@link fr.smartprod.paperdms.monitoring.web.rest.AlertResource} to receive
...
public class AlertCriteria implements Serializable, Criteria {
	...
	public boolean equals(Object o) {
		...
		return (Objects.equals(id, that.id) && Objects.equals(alertRuleId, that.alertRuleId)
				&& Objects.equals(severity, that.severity) && Objects.equals(title, that.title)
				&& Objects.equals(entityType, that.entityType) && Objects.equals(entityId, that.entityId)
				&& Objects.equals(status, that.status) && Objects.equals(triggeredDate, that.triggeredDate)
				&& Objects.equals(acknowledgedBy, that.acknowledgedBy)
				&& Objects.equals(acknowledgedDate, that.acknowledgedDate)
				&& Objects.equals(resolvedBy, that.resolvedBy) && Objects.equals(resolvedDate, that.resolvedDate)
				&& Objects.equals(alertRuleId, that.alertRuleId) && Objects.equals(distinct, that.distinct));
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, alertRuleId, severity, title, entityType, entityId, status, triggeredDate,
				acknowledgedBy, acknowledgedDate, resolvedBy, resolvedDate, alertRuleId, distinct);
	}

	// prettier-ignore
	@Override
	public String toString() {
		return "AlertCriteria{" + optionalId().map(f -> "id=" + f + ", ").orElse("")
