...
public class OcrCacheResource {
    ...
    public OcrCacheResource(OcrCacheService ocrCacheService, OcrCacheRepository ocrCacheRepository) {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<OcrCacheDTO>> getAllOcrCaches(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of OcrCaches");
        Page<OcrCacheDTO> page = ocrCacheService.findAll(pageable);
