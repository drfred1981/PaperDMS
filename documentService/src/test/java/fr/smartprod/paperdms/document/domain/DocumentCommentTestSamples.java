...
public class DocumentCommentTestSamples {
    ...
    public static DocumentComment getDocumentCommentSample1() {
        return new DocumentComment().id(1L).documentId(1L).pageNumber(1).authorId("authorId1");
    }

    public static DocumentComment getDocumentCommentSample2() {
        return new DocumentComment().id(2L).documentId(2L).pageNumber(2).authorId("authorId2");
    }
