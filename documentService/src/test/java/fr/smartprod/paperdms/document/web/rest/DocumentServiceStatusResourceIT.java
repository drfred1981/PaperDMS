...
class DocumentServiceStatusResourceIT {
    ...
    void checkDocumentIdIsRequired() throws Exception {
        ...
        int searchDatabaseSizeBefore = IterableUtil.sizeOf(documentServiceStatusSearchRepository.findAll());
        // set the field null
        documentServiceStatus.setDocumentId(null);
    ...
    @Test
    @Transactional
    void getAllDocumentServiceStatusesByDocumentIdIsEqualToSomething() throws Exception {
        // Initialize the database
        insertedDocumentServiceStatus = documentServiceStatusRepository.saveAndFlush(documentServiceStatus);

        // Get all the documentServiceStatusList where documentId equals to
        defaultDocumentServiceStatusFiltering("documentId.equals=" + DEFAULT_DOCUMENT_ID, "documentId.equals=" + UPDATED_DOCUMENT_ID);
    }

    @Test
    @Transactional
    void getAllDocumentServiceStatusesByDocumentIdIsInShouldWork() throws Exception {
        // Initialize the database
        insertedDocumentServiceStatus = documentServiceStatusRepository.saveAndFlush(documentServiceStatus);

        // Get all the documentServiceStatusList where documentId in
    ...
    @Test
    @Transactional
    void getAllDocumentServiceStatusesByDocumentIdIsNullOrNotNull() throws Exception {
        // Initialize the database
        insertedDocumentServiceStatus = documentServiceStatusRepository.saveAndFlush(documentServiceStatus);

        // Get all the documentServiceStatusList where documentId is not null
        defaultDocumentServiceStatusFiltering("documentId.specified=true", "documentId.specified=false");
    }

    @Test
    @Transactional
    void getAllDocumentServiceStatusesByDocumentIdIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedDocumentServiceStatus = documentServiceStatusRepository.saveAndFlush(documentServiceStatus);

        // Get all the documentServiceStatusList where documentId is greater than or equal to
        defaultDocumentServiceStatusFiltering(
    ...
    @Test
    @Transactional
    void getAllDocumentServiceStatusesByDocumentIdIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        insertedDocumentServiceStatus = documentServiceStatusRepository.saveAndFlush(documentServiceStatus);

        // Get all the documentServiceStatusList where documentId is less than or equal to
        defaultDocumentServiceStatusFiltering(
    ...
    @Test
    @Transactional
    void getAllDocumentServiceStatusesByDocumentIdIsLessThanSomething() throws Exception {
        // Initialize the database
        insertedDocumentServiceStatus = documentServiceStatusRepository.saveAndFlush(documentServiceStatus);

        // Get all the documentServiceStatusList where documentId is less than
        defaultDocumentServiceStatusFiltering("documentId.lessThan=" + UPDATED_DOCUMENT_ID, "documentId.lessThan=" + DEFAULT_DOCUMENT_ID);
    }

    @Test
    @Transactional
    void getAllDocumentServiceStatusesByDocumentIdIsGreaterThanSomething() throws Exception {
        // Initialize the database
        insertedDocumentServiceStatus = documentServiceStatusRepository.saveAndFlush(documentServiceStatus);

        // Get all the documentServiceStatusList where documentId is greater than
        defaultDocumentServiceStatusFiltering(
