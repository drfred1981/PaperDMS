 ...
 * {@link fr.smartprod.paperdms.document.domain.DocumentServiceStatus} entity.
 * This class is used in
 * {@link fr.smartprod.paperdms.document.web.rest.DocumentServiceStatusResource}
...
public class DocumentServiceStatusCriteria implements Serializable, Criteria {
	...
	public boolean equals(Object o) {
		...
		return (Objects.equals(id, that.id) && Objects.equals(documentId, that.documentId)
				&& Objects.equals(serviceType, that.serviceType) && Objects.equals(status, that.status)
				...
				&& Objects.equals(processingDuration, that.processingDuration) && Objects.equals(jobId, that.jobId)
				&& Objects.equals(priority, that.priority) && Objects.equals(updatedBy, that.updatedBy)
				&& Objects.equals(updatedDate, that.updatedDate) && Objects.equals(documentId, that.documentId)
				&& Objects.equals(distinct, that.distinct));
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, documentId, serviceType, status, retryCount, lastProcessedDate, processingStartDate,
				processingEndDate, processingDuration, jobId, priority, updatedBy, updatedDate, documentId, distinct);
	}

	// prettier-ignore
	@Override
	public String toString() {
		return "DocumentServiceStatusCriteria{" + optionalId().map(f -> "id=" + f + ", ").orElse("")
