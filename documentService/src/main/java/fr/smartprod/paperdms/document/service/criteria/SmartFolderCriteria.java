...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.document.domain.SmartFolder} entity. This class is used
 * in {@link fr.smartprod.paperdms.document.web.rest.SmartFolderResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /smart-folders?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SmartFolderCriteria implements Serializable, Criteria {
    ...
    public SmartFolderCriteria() {}

    public SmartFolderCriteria(SmartFolderCriteria other) {
    ...
    @Override
    public SmartFolderCriteria copy() {
        return new SmartFolderCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SmartFolderCriteria that = (SmartFolderCriteria) o;
        return (
