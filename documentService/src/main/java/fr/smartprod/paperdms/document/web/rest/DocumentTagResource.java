...
public class DocumentTagResource {
    ...
    public DocumentTagResource(DocumentTagService documentTagService, DocumentTagRepository documentTagRepository) {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<DocumentTagDTO>> getAllDocumentTags(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        LOG.debug("REST request to get a page of DocumentTags");
        Page<DocumentTagDTO> page = documentTagService.findAll(pageable);
