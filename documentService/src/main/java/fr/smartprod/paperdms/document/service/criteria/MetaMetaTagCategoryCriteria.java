...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.document.domain.MetaMetaTagCategory} entity. This class is used
 * in {@link fr.smartprod.paperdms.document.web.rest.MetaMetaTagCategoryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /meta-meta-tag-categories?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class MetaMetaTagCategoryCriteria implements Serializable, Criteria {
    ...
    private LongFilter metaTagsId;

    private LongFilter parentId;

    private Boolean distinct;

    public MetaMetaTagCategoryCriteria() {}

    public MetaMetaTagCategoryCriteria(MetaMetaTagCategoryCriteria other) {
        ...
        this.metaTagsId = other.optionalMetaTagsId().map(LongFilter::copy).orElse(null);
        this.parentId = other.optionalParentId().map(LongFilter::copy).orElse(null);
        this.distinct = other.distinct;
    }

    @Override
    public MetaMetaTagCategoryCriteria copy() {
        return new MetaMetaTagCategoryCriteria(this);
    }
    ...
    public LongFilter getMetaTagsId() {
        return metaTagsId;
    }

    public Optional<LongFilter> optionalMetaTagsId() {
        return Optional.ofNullable(metaTagsId);
    }

    public LongFilter metaTagsId() {
        if (metaTagsId == null) {
            setMetaTagsId(new LongFilter());
        }
        return metaTagsId;
    }

    public void setMetaTagsId(LongFilter metaTagsId) {
        this.metaTagsId = metaTagsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final MetaMetaTagCategoryCriteria that = (MetaMetaTagCategoryCriteria) o;
        return (
            ...
            Objects.equals(metaTagsId, that.metaTagsId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, color, displayOrder, isSystem, createdDate, createdBy, childrenId, metaTagsId, parentId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "MetaMetaTagCategoryCriteria{" +
            ...
            optionalMetaTagsId().map(f -> "metaTagsId=" + f + ", ").orElse("") +
