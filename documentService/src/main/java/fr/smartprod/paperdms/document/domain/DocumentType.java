...
public class DocumentType implements Serializable {
    ...
    public void setDocumentTemplates(Set<DocumentTemplate> documentTemplates) {
        if (this.documentTemplates != null) {
            this.documentTemplates.forEach(i -> i.setDocumentType(null));
        }
        if (documentTemplates != null) {
            documentTemplates.forEach(i -> i.setDocumentType(this));
        }
        this.documentTemplates = documentTemplates;
    }

    public DocumentType documentTemplates(Set<DocumentTemplate> documentTemplates) {
        this.setDocumentTemplates(documentTemplates);
        return this;
    }

    public DocumentType addDocumentTemplates(DocumentTemplate documentTemplate) {
        this.documentTemplates.add(documentTemplate);
        documentTemplate.setDocumentType(this);
        return this;
    }

    public DocumentType removeDocumentTemplates(DocumentTemplate documentTemplate) {
        this.documentTemplates.remove(documentTemplate);
        documentTemplate.setDocumentType(null);
        return this;
    }
