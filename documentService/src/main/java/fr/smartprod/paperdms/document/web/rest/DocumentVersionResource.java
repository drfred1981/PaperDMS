...
public class DocumentVersionResource {
    ...
    public DocumentVersionResource(DocumentVersionService documentVersionService, DocumentVersionRepository documentVersionRepository) {
    ...
    public ResponseEntity<List<DocumentVersionDTO>> getAllDocumentVersions(
        ...
        LOG.debug("REST request to get a page of DocumentVersions");
        Page<DocumentVersionDTO> page = documentVersionService.findAll(pageable);
