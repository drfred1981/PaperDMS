...
public class DocumentPermissionCriteria implements Serializable, Criteria {
    ...
    private LongFilter permissionGroupId;
    ...
    public DocumentPermissionCriteria(DocumentPermissionCriteria other) {
        ...
        this.permissionGroupId = other.optionalPermissionGroupId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getPermissionGroupId() {
        return permissionGroupId;
    }

    public Optional<LongFilter> optionalPermissionGroupId() {
        return Optional.ofNullable(permissionGroupId);
    }

    public LongFilter permissionGroupId() {
        if (permissionGroupId == null) {
            setPermissionGroupId(new LongFilter());
        }
        return permissionGroupId;
    }

    public void setPermissionGroupId(LongFilter permissionGroupId) {
    ...
    public String toString() {
        return "DocumentPermissionCriteria{" +
            ...
            optionalPermissionGroupId().map(f -> "permissionGroupId=" + f + ", ").orElse("") +
