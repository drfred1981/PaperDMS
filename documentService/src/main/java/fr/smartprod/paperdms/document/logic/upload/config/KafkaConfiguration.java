 ...
 * Configures JSON serialization for document events.
 */
@Configuration
public class KafkaConfiguration {
    ...
    /**
     * Create Kafka producer factory for document events.
     *
     * @return ProducerFactory for DocumentEvent
     */
    @Bean
    ...
    /**
     * Create Kafka template for document events.
     *
     * @return KafkaTemplate for DocumentEvent
     */
    @Bean
