...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.notification.domain.NotificationWebhookSubscription} entity. This class is used
 * in {@link fr.smartprod.paperdms.notification.web.rest.NotificationWebhookSubscriptionResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /notification-webhook-subscriptions?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class NotificationWebhookSubscriptionCriteria implements Serializable, Criteria {
    ...
    private LongFilter notificationWebhookLogsId;

    private Boolean distinct;

    public NotificationWebhookSubscriptionCriteria() {}

    public NotificationWebhookSubscriptionCriteria(NotificationWebhookSubscriptionCriteria other) {
        ...
        this.notificationWebhookLogsId = other.optionalNotificationWebhookLogsId().map(LongFilter::copy).orElse(null);
        this.distinct = other.distinct;
    }

    @Override
    public NotificationWebhookSubscriptionCriteria copy() {
        return new NotificationWebhookSubscriptionCriteria(this);
    }
    ...
    public LongFilter getNotificationWebhookLogsId() {
        return notificationWebhookLogsId;
    }

    public Optional<LongFilter> optionalNotificationWebhookLogsId() {
        return Optional.ofNullable(notificationWebhookLogsId);
    }

    public LongFilter notificationWebhookLogsId() {
        if (notificationWebhookLogsId == null) {
            setNotificationWebhookLogsId(new LongFilter());
        }
        return notificationWebhookLogsId;
    }

    public void setNotificationWebhookLogsId(LongFilter notificationWebhookLogsId) {
        this.notificationWebhookLogsId = notificationWebhookLogsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final NotificationWebhookSubscriptionCriteria that = (NotificationWebhookSubscriptionCriteria) o;
        return (
            ...
            Objects.equals(notificationWebhookLogsId, that.notificationWebhookLogsId) &&
    ...
    public String toString() {
        return "NotificationWebhookSubscriptionCriteria{" +
            ...
            optionalNotificationWebhookLogsId().map(f -> "notificationWebhookLogsId=" + f + ", ").orElse("") +
