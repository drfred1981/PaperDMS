...
public class NotificationTemplate implements Serializable {
    ...
    public void setNotifications(Set<Notification> notifications) {
        if (this.notifications != null) {
            this.notifications.forEach(i -> i.setTemplate(null));
        }
        if (notifications != null) {
            notifications.forEach(i -> i.setTemplate(this));
        }
        this.notifications = notifications;
    }

    public NotificationTemplate notifications(Set<Notification> notifications) {
        this.setNotifications(notifications);
        return this;
    }

    public NotificationTemplate addNotifications(Notification notification) {
        this.notifications.add(notification);
        notification.setTemplate(this);
        return this;
    }

    public NotificationTemplate removeNotifications(Notification notification) {
