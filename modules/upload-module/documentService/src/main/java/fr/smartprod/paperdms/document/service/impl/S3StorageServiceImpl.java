 ...
 * Handles upload, download, deletion, and SHA-256 deduplication.
 */
@Service
public class S3StorageService {
    ...
    /**
     * Upload a file to S3 with deduplication check.
     * Uses SHA-256 hash as the primary key to avoid duplicate storage.
     *
    ...
    /**
     * Generate S3 key from SHA-256 hash and file name.
     * Format: documents/[first 2 chars of hash]/[next 2 chars]/[full hash].[extension]
     *
