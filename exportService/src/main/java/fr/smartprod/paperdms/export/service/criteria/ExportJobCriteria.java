...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.export.domain.ExportJob}
 * entity. This class is used in
 * {@link fr.smartprod.paperdms.export.web.rest.ExportJobResource} to receive
...
public class ExportJobCriteria implements Serializable, Criteria {
	...
	public boolean equals(Object o) {
		...
		return (Objects.equals(id, that.id) && Objects.equals(name, that.name)
				...
				&& Objects.equals(s3ExportKey, that.s3ExportKey) && Objects.equals(exportSize, that.exportSize)
				&& Objects.equals(documentCount, that.documentCount)
				&& Objects.equals(filesGenerated, that.filesGenerated) && Objects.equals(status, that.status)
				&& Objects.equals(startDate, that.startDate) && Objects.equals(endDate, that.endDate)
				&& Objects.equals(createdBy, that.createdBy) && Objects.equals(createdDate, that.createdDate)
				&& Objects.equals(exportPatternId, that.exportPatternId) && Objects.equals(distinct, that.distinct));
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, name, exportPatternId, exportFormat, includeMetadata, includeVersions, includeComments,
				includeAuditTrail, s3ExportKey, exportSize, documentCount, filesGenerated, status, startDate, endDate,
				createdBy, createdDate, exportPatternId, distinct);
	}

	// prettier-ignore
	@Override
	public String toString() {
		return "ExportJobCriteria{" + optionalId().map(f -> "id=" + f + ", ").orElse("")
