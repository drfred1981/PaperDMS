package fr.smartprod.paperdms.export.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, fr.smartprod.paperdms.export.domain.ExportJob.class.getName() + ".exportResults", jcacheConfiguration);
            createCache(cm, fr.smartprod.paperdms.export.domain.ExportPattern.class.getName(), jcacheConfiguration);
            createCache(cm, fr.smartprod.paperdms.export.domain.ExportPattern.class.getName() + ".exportJobs", jcacheConfiguration);
