...
public class ExportResult implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties(value = { "exportPattern" }, allowSetters = true)
    ...
    public ExportResult exportJobId(Long exportJobId) {
    ...
    public ExportResult documentId(Long documentId) {
