...
public class ExportJob implements Serializable {
    ...
    @NotNull
    @Column(name = "export_pattern_id", nullable = false)
    ...
    public Long getExportPatternId() {
        return this.exportPatternId;
    }

    public ExportJob exportPatternId(Long exportPatternId) {
        this.setExportPatternId(exportPatternId);
        return this;
    }
