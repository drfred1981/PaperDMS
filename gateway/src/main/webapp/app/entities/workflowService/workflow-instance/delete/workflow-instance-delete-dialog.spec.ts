...
import { WorkflowInstanceDeleteDialog } from './workflow-instance-delete-dialog';

describe('WorkflowInstance Management Delete Component', () => {
  let comp: WorkflowInstanceDeleteDialog;
  let fixture: ComponentFixture<WorkflowInstanceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WorkflowInstanceDeleteDialog);
