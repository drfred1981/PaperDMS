...
import { sampleWithRequiredData } from '../workflow-instance.test-samples';

import { WorkflowInstance } from './workflow-instance';

describe('WorkflowInstance Management Component', () => {
  let comp: WorkflowInstance;
  let fixture: ComponentFixture<WorkflowInstance>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WorkflowInstance);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.workflowInstances()[0]).toEqual(expect.objectContaining({ id: 15006 }));
  });

  describe('trackId', () => {
    it('should forward to workflowInstanceService', () => {
      const entity = { id: 15006 };
      jest.spyOn(service, 'getWorkflowInstanceIdentifier');
      const id = comp.trackId(entity);
      expect(service.getWorkflowInstanceIdentifier).toHaveBeenCalledWith(entity);
