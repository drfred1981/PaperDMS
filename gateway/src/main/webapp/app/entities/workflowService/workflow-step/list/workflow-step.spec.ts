...
import { sampleWithRequiredData } from '../workflow-step.test-samples';

import { WorkflowStep } from './workflow-step';

describe('WorkflowStep Management Component', () => {
  let comp: WorkflowStep;
  let fixture: ComponentFixture<WorkflowStep>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WorkflowStep);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.workflowSteps()[0]).toEqual(expect.objectContaining({ id: 22856 }));
  });

  describe('trackId', () => {
    it('should forward to workflowStepService', () => {
      const entity = { id: 22856 };
      jest.spyOn(service, 'getWorkflowStepIdentifier');
      const id = comp.trackId(entity);
      expect(service.getWorkflowStepIdentifier).toHaveBeenCalledWith(entity);
