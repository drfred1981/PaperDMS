...
import { sampleWithRequiredData } from '../workflow-approval-history.test-samples';
...
describe('WorkflowApprovalHistory Management Component', () => {
  let comp: WorkflowApprovalHistoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(WorkflowApprovalHistoryComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.workflowApprovalHistories()[0]).toEqual(expect.objectContaining({ id: 17441 }));
  });

  describe('trackId', () => {
    it('should forward to workflowApprovalHistoryService', () => {
      const entity = { id: 17441 };
      jest.spyOn(service, 'getWorkflowApprovalHistoryIdentifier');
      const id = comp.trackId(entity);
      expect(service.getWorkflowApprovalHistoryIdentifier).toHaveBeenCalledWith(entity);
