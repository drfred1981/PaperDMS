...
import { sampleWithRequiredData } from '../approval-history.test-samples';
import { ApprovalHistoryService } from '../service/approval-history.service';

import { ApprovalHistory } from './approval-history';

describe('ApprovalHistory Management Component', () => {
  let comp: ApprovalHistory;
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.approvalHistories()[0]).toEqual(expect.objectContaining({ id: 15176 }));
  });

  describe('trackId', () => {
    it('should forward to approvalHistoryService', () => {
      const entity = { id: 15176 };
      jest.spyOn(service, 'getApprovalHistoryIdentifier');
      const id = comp.trackId(entity);
      expect(service.getApprovalHistoryIdentifier).toHaveBeenCalledWith(entity);
