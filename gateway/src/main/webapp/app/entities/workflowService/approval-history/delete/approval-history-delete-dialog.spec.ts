...
import { ApprovalHistoryDeleteDialog } from './approval-history-delete-dialog';

describe('ApprovalHistory Management Delete Component', () => {
  let comp: ApprovalHistoryDeleteDialog;
  let fixture: ComponentFixture<ApprovalHistoryDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ApprovalHistoryDeleteDialog);
