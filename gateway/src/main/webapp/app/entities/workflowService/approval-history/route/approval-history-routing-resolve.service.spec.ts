...
describe('ApprovalHistory routing resolve service', () => {
  ...
  let resultApprovalHistory: IApprovalHistory | null | undefined;
  ...
  beforeEach(() => {
    ...
    resultApprovalHistory = undefined;
  });

  describe('resolve', () => {
    it('should return IApprovalHistory returned by find', () => {
      // GIVEN
      ...
      expect(resultApprovalHistory).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultApprovalHistory).toEqual(null);
    });
    ...
    it('should route to 404 page if data not found in server', () => {
      ...
      // THEN
      expect(service.find).toHaveBeenCalledWith(123);
      expect(resultApprovalHistory).toEqual(undefined);
