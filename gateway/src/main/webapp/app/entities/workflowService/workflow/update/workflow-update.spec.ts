...
describe('Workflow Management Update Component', () => {
  let comp: WorkflowUpdate;
  let fixture: ComponentFixture<WorkflowUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WorkflowUpdate);
  ...
  describe('ngOnInit', () => {
    it('should update editForm', () => {
      const workflow: IWorkflow = { id: 32445 };
