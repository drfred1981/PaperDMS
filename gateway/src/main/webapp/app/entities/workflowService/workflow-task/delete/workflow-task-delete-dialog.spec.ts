...
import { WorkflowTaskDeleteDialog } from './workflow-task-delete-dialog';

describe('WorkflowTask Management Delete Component', () => {
  let comp: WorkflowTaskDeleteDialog;
  let fixture: ComponentFixture<WorkflowTaskDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WorkflowTaskDeleteDialog);
