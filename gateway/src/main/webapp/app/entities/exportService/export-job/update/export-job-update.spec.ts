...
import { ExportJobUpdate } from './export-job-update';

describe('ExportJob Management Update Component', () => {
  let comp: ExportJobUpdate;
  let fixture: ComponentFixture<ExportJobUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ExportJobUpdate);
  ...
  describe('ngOnInit', () => {
    it('should call ExportPattern query and add missing value', () => {
      ...
      expect(exportPatternService.addExportPatternToCollectionIfMissing).toHaveBeenCalledWith(
        ...
        ...additionalExportPatterns.map(i => expect.objectContaining(i) as typeof i),
      );
