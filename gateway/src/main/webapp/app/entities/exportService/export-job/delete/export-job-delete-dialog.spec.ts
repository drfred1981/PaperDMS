...
import { ExportJobDeleteDialog } from './export-job-delete-dialog';

describe('ExportJob Management Delete Component', () => {
  let comp: ExportJobDeleteDialog;
  let fixture: ComponentFixture<ExportJobDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ExportJobDeleteDialog);
