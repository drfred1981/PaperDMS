...
import { ExportPatternDeleteDialog } from './export-pattern-delete-dialog';

describe('ExportPattern Management Delete Component', () => {
  let comp: ExportPatternDeleteDialog;
  let fixture: ComponentFixture<ExportPatternDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ExportPatternDeleteDialog);
