...
import { ExportPatternUpdate } from './export-pattern-update';

describe('ExportPattern Management Update Component', () => {
  let comp: ExportPatternUpdate;
  let fixture: ComponentFixture<ExportPatternUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ExportPatternUpdate);
