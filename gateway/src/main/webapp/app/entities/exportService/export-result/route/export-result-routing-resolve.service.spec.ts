...
describe('ExportResult routing resolve service', () => {
  ...
  let resultExportResult: IExportResult | null | undefined;
  ...
  beforeEach(() => {
    ...
    resultExportResult = undefined;
  });

  describe('resolve', () => {
    it('should return IExportResult returned by find', () => {
      // GIVEN
      ...
      expect(resultExportResult).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultExportResult).toEqual(null);
    });
    ...
    it('should route to 404 page if data not found in server', () => {
      ...
      // THEN
      expect(service.find).toHaveBeenCalledWith(123);
      expect(resultExportResult).toEqual(undefined);
