...
import { ExportResultUpdate } from './export-result-update';

describe('ExportResult Management Update Component', () => {
  let comp: ExportResultUpdate;
  let fixture: ComponentFixture<ExportResultUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ExportResultUpdate);
  ...
  describe('ngOnInit', () => {
    it('should call ExportJob query and add missing value', () => {
      ...
      expect(exportJobService.addExportJobToCollectionIfMissing).toHaveBeenCalledWith(
        exportJobCollection,
        ...additionalExportJobs.map(i => expect.objectContaining(i) as typeof i),
      );
