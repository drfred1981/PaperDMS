...
import { sampleWithRequiredData } from '../scheduled-report.test-samples';
import { ScheduledReportService } from '../service/scheduled-report.service';

import { ScheduledReport } from './scheduled-report';

describe('ScheduledReport Management Component', () => {
  let comp: ScheduledReport;
  let fixture: ComponentFixture<ScheduledReport>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ScheduledReport);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.scheduledReports()[0]).toEqual(expect.objectContaining({ id: 28944 }));
  });

  describe('trackId', () => {
    it('should forward to scheduledReportService', () => {
      const entity = { id: 28944 };
      jest.spyOn(service, 'getScheduledReportIdentifier');
      const id = comp.trackId(entity);
      expect(service.getScheduledReportIdentifier).toHaveBeenCalledWith(entity);
