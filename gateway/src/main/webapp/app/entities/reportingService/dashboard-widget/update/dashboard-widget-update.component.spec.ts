...
import { DashboardWidgetUpdateComponent } from './dashboard-widget-update.component';

describe('DashboardWidget Management Update Component', () => {
  let comp: DashboardWidgetUpdateComponent;
  let fixture: ComponentFixture<DashboardWidgetUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [DashboardWidgetUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(DashboardWidgetUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(DashboardWidgetUpdateComponent);
