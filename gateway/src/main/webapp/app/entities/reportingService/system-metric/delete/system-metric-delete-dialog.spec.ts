...
import { SystemMetricDeleteDialog } from './system-metric-delete-dialog';

describe('SystemMetric Management Delete Component', () => {
  let comp: SystemMetricDeleteDialog;
  let fixture: ComponentFixture<SystemMetricDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SystemMetricDeleteDialog);
