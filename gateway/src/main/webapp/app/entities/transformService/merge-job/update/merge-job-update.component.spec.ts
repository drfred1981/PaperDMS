...
import { MergeJobUpdateComponent } from './merge-job-update.component';

describe('MergeJob Management Update Component', () => {
  let comp: MergeJobUpdateComponent;
  let fixture: ComponentFixture<MergeJobUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [MergeJobUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(MergeJobUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(MergeJobUpdateComponent);
