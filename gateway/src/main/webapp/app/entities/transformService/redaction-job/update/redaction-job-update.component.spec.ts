...
import { RedactionJobUpdateComponent } from './redaction-job-update.component';

describe('RedactionJob Management Update Component', () => {
  let comp: RedactionJobUpdateComponent;
  let fixture: ComponentFixture<RedactionJobUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RedactionJobUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(RedactionJobUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(RedactionJobUpdateComponent);
