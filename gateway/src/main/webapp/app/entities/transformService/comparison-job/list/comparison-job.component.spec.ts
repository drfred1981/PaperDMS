...
import { ComparisonJobComponent } from './comparison-job.component';
import SpyInstance = jest.SpyInstance;

describe('ComparisonJob Management Component', () => {
  let comp: ComparisonJobComponent;
  let fixture: ComponentFixture<ComparisonJobComponent>;
  let service: ComparisonJobService;
  let routerNavigateSpy: SpyInstance<Promise<boolean>>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ComparisonJobComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(ComparisonJobComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(ComparisonJobComponent);
