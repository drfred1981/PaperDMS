...
import { ComparisonJobDeleteDialog } from './comparison-job-delete-dialog';

describe('ComparisonJob Management Delete Component', () => {
  let comp: ComparisonJobDeleteDialog;
  let fixture: ComponentFixture<ComparisonJobDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ComparisonJobDeleteDialog);
