...
import { CompressionJobUpdate } from './compression-job-update';

describe('CompressionJob Management Update Component', () => {
  let comp: CompressionJobUpdate;
  let fixture: ComponentFixture<CompressionJobUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CompressionJobUpdate);
