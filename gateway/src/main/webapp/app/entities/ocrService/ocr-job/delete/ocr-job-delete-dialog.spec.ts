...
import { OcrJobDeleteDialog } from './ocr-job-delete-dialog';

describe('OcrJob Management Delete Component', () => {
  let comp: OcrJobDeleteDialog;
  let fixture: ComponentFixture<OcrJobDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OcrJobDeleteDialog);
