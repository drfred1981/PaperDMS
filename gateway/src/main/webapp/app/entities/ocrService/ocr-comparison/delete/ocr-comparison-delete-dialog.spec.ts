...
import { OcrComparisonDeleteDialog } from './ocr-comparison-delete-dialog';

describe('OcrComparison Management Delete Component', () => {
  let comp: OcrComparisonDeleteDialog;
  let fixture: ComponentFixture<OcrComparisonDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OcrComparisonDeleteDialog);
