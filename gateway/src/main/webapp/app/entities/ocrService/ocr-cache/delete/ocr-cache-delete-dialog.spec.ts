...
import { OcrCacheDeleteDialog } from './ocr-cache-delete-dialog';

describe('OcrCache Management Delete Component', () => {
  let comp: OcrCacheDeleteDialog;
  let fixture: ComponentFixture<OcrCacheDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OcrCacheDeleteDialog);
