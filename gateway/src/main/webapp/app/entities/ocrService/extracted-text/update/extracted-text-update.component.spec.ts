...
import { ExtractedTextUpdateComponent } from './extracted-text-update.component';

describe('ExtractedText Management Update Component', () => {
  let comp: ExtractedTextUpdateComponent;
  let fixture: ComponentFixture<ExtractedTextUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ExtractedTextUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(ExtractedTextUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(ExtractedTextUpdateComponent);
