...
@Component({
  ...
  templateUrl: './extracted-text-update.html',
  imports: [SharedModule, ReactiveFormsModule],
})
export class ExtractedTextUpdate implements OnInit {
  isSaving = false;
  ...
  protected updateForm(extractedText: IExtractedText): void {
    ...
    this.ocrJobsSharedCollection.set(
      this.ocrJobService.addOcrJobToCollectionIfMissing<IOcrJob>(this.ocrJobsSharedCollection(), extractedText.job),
    );
  }
