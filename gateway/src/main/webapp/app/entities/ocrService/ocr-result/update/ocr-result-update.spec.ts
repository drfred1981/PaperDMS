...
import { OcrResultUpdate } from './ocr-result-update';

describe('OcrResult Management Update Component', () => {
  let comp: OcrResultUpdate;
  let fixture: ComponentFixture<OcrResultUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(OcrResultUpdate);
