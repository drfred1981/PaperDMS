...
import { sampleWithRequiredData } from '../meta-tag.test-samples';
import { MetaTagService } from '../service/meta-tag.service';

import { MetaTagComponent } from './meta-tag.component';
import SpyInstance = jest.SpyInstance;

describe('MetaTag Management Component', () => {
  let comp: MetaTagComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(MetaTagComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.metaTags()[0]).toEqual(expect.objectContaining({ id: 11753 }));
  });

  describe('trackId', () => {
    it('should forward to metaTagService', () => {
      const entity = { id: 11753 };
      jest.spyOn(service, 'getMetaTagIdentifier');
      const id = comp.trackId(entity);
      expect(service.getMetaTagIdentifier).toHaveBeenCalledWith(entity);
