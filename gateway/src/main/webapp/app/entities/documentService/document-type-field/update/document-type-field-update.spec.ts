...
import { DocumentTypeFieldUpdate } from './document-type-field-update';

describe('DocumentTypeField Management Update Component', () => {
  let comp: DocumentTypeFieldUpdate;
  let fixture: ComponentFixture<DocumentTypeFieldUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentTypeFieldUpdate);
