...
import { DocumentTypeFieldDeleteDialog } from './document-type-field-delete-dialog';

describe('DocumentTypeField Management Delete Component', () => {
  let comp: DocumentTypeFieldDeleteDialog;
  let fixture: ComponentFixture<DocumentTypeFieldDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentTypeFieldDeleteDialog);
