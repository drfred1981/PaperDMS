...
import { DocumentVersionDeleteDialog } from './document-version-delete-dialog';

describe('DocumentVersion Management Delete Component', () => {
  let comp: DocumentVersionDeleteDialog;
  let fixture: ComponentFixture<DocumentVersionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentVersionDeleteDialog);
