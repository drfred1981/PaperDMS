...
@Component({
  ...
  templateUrl: './folder-update.html',
  imports: [SharedModule, ReactiveFormsModule],
})
export class FolderUpdate implements OnInit {
  isSaving = false;
  ...
  protected updateForm(folder: IFolder): void {
    ...
    this.foldersSharedCollection.set(
      this.folderService.addFolderToCollectionIfMissing<IFolder>(this.foldersSharedCollection(), folder.parent),
    );
  }
