...
describe('DocumentTemplate Management Delete Component', () => {
  let comp: DocumentTemplateDeleteDialog;
  let fixture: ComponentFixture<DocumentTemplateDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentTemplateDeleteDialog);
