...
import { DocumentTemplateUpdate } from './document-template-update';

describe('DocumentTemplate Management Update Component', () => {
  let comp: DocumentTemplateUpdate;
  let fixture: ComponentFixture<DocumentTemplateUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentTemplateUpdate);
