...
import { sampleWithRequiredData } from '../document-template.test-samples';
...
describe('DocumentTemplate Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.documentTemplates()[0]).toEqual(expect.objectContaining({ id: 25776 }));
  });

  describe('trackId', () => {
    it('should forward to documentTemplateService', () => {
      const entity = { id: 25776 };
      jest.spyOn(service, 'getDocumentTemplateIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDocumentTemplateIdentifier).toHaveBeenCalledWith(entity);
