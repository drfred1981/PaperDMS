...
import { DocumentServiceStatusDeleteDialog } from './document-service-status-delete-dialog';

describe('DocumentServiceStatus Management Delete Component', () => {
  let comp: DocumentServiceStatusDeleteDialog;
  let fixture: ComponentFixture<DocumentServiceStatusDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentServiceStatusDeleteDialog);
