...
import { DocumentPermissionDeleteDialog } from './document-permission-delete-dialog';

describe('DocumentPermission Management Delete Component', () => {
  let comp: DocumentPermissionDeleteDialog;
  let fixture: ComponentFixture<DocumentPermissionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentPermissionDeleteDialog);
