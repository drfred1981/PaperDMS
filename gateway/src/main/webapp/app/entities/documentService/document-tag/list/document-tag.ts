...
import { DocumentTagDeleteDialog } from '../delete/document-tag-delete-dialog';
...
export class DocumentTag implements OnInit {
  ...
  delete(documentTag: IDocumentTag): void {
    const modalRef = this.modalService.open(DocumentTagDeleteDialog, { size: 'lg', backdrop: 'static' });
