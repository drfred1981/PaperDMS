...
import { DocumentTagUpdate } from './document-tag-update';

describe('DocumentTag Management Update Component', () => {
  let comp: DocumentTagUpdate;
  let fixture: ComponentFixture<DocumentTagUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentTagUpdate);
