...
@Component({
  ...
  templateUrl: './document-tag-update.html',
  imports: [SharedModule, ReactiveFormsModule],
})
export class DocumentTagUpdate implements OnInit {
  isSaving = false;
  ...
  protected updateForm(documentTag: IDocumentTag): void {
    ...
    this.documentsSharedCollection.set(
      this.documentService.addDocumentToCollectionIfMissing<IDocument>(this.documentsSharedCollection(), documentTag.document),
    );
    this.tagsSharedCollection.set(this.tagService.addTagToCollectionIfMissing<ITag>(this.tagsSharedCollection(), documentTag.tag));
  }
