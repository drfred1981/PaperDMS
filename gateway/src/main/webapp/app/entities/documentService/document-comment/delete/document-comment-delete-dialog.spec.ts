...
import { DocumentCommentDeleteDialog } from './document-comment-delete-dialog';

describe('DocumentComment Management Delete Component', () => {
  let comp: DocumentCommentDeleteDialog;
  let fixture: ComponentFixture<DocumentCommentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentCommentDeleteDialog);
