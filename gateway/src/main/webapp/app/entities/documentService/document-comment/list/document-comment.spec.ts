...
import { sampleWithRequiredData } from '../document-comment.test-samples';
import { DocumentCommentService } from '../service/document-comment.service';

import { DocumentComment } from './document-comment';

describe('DocumentComment Management Component', () => {
  let comp: DocumentComment;
  let fixture: ComponentFixture<DocumentComment>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentComment);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.documentComments()[0]).toEqual(expect.objectContaining({ id: 5301 }));
  });

  describe('trackId', () => {
    it('should forward to documentCommentService', () => {
      const entity = { id: 5301 };
      jest.spyOn(service, 'getDocumentCommentIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDocumentCommentIdentifier).toHaveBeenCalledWith(entity);
