...
import { DocumentCommentUpdate } from './document-comment-update';

describe('DocumentComment Management Update Component', () => {
  let comp: DocumentCommentUpdate;
  let fixture: ComponentFixture<DocumentCommentUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentCommentUpdate);
  ...
  describe('ngOnInit', () => {
    it('should call DocumentComment query and add missing value', () => {
      ...
      expect(documentCommentService.addDocumentCommentToCollectionIfMissing).toHaveBeenCalledWith(
        ...
        ...additionalDocumentComments.map(i => expect.objectContaining(i) as typeof i),
      );
