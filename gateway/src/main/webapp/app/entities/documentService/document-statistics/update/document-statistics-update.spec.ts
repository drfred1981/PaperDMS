...
import { DocumentStatisticsUpdate } from './document-statistics-update';

describe('DocumentStatistics Management Update Component', () => {
  let comp: DocumentStatisticsUpdate;
  let fixture: ComponentFixture<DocumentStatisticsUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentStatisticsUpdate);
