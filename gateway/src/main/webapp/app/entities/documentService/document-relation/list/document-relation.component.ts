...
import { DocumentRelationDeleteDialogComponent } from '../delete/document-relation-delete-dialog.component';
...
export class DocumentRelationComponent implements OnInit {
  ...
  delete(documentRelation: IDocumentRelation): void {
    const modalRef = this.modalService.open(DocumentRelationDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
