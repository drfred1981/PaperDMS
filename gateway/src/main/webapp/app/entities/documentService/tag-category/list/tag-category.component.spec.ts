...
import { sampleWithRequiredData } from '../tag-category.test-samples';
...
describe('TagCategory Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.tagCategories()[0]).toEqual(expect.objectContaining({ id: 10601 }));
  });

  describe('trackId', () => {
    it('should forward to tagCategoryService', () => {
      const entity = { id: 10601 };
      jest.spyOn(service, 'getTagCategoryIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTagCategoryIdentifier).toHaveBeenCalledWith(entity);
