...
import { sampleWithRequiredData } from '../bookmark.test-samples';
...
describe('Bookmark Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.bookmarks()[0]).toEqual(expect.objectContaining({ id: 18281 }));
  });

  describe('trackId', () => {
    it('should forward to bookmarkService', () => {
      const entity = { id: 18281 };
      jest.spyOn(service, 'getBookmarkIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBookmarkIdentifier).toHaveBeenCalledWith(entity);
