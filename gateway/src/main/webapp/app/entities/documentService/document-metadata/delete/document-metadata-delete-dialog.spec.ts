...
import { DocumentMetadataDeleteDialog } from './document-metadata-delete-dialog';

describe('DocumentMetadata Management Delete Component', () => {
  let comp: DocumentMetadataDeleteDialog;
  let fixture: ComponentFixture<DocumentMetadataDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentMetadataDeleteDialog);
