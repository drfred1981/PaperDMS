...
describe('SavedSearch Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.savedSearches()[0]).toEqual(expect.objectContaining({ id: 32351 }));
  });

  describe('trackId', () => {
    it('should forward to savedSearchService', () => {
      const entity = { id: 32351 };
      jest.spyOn(service, 'getSavedSearchIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSavedSearchIdentifier).toHaveBeenCalledWith(entity);
