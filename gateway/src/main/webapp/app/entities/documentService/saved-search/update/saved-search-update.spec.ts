...
import { SavedSearchUpdate } from './saved-search-update';

describe('SavedSearch Management Update Component', () => {
  let comp: SavedSearchUpdate;
  let fixture: ComponentFixture<SavedSearchUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SavedSearchUpdate);
