...
describe('PermissionGroup Management Delete Component', () => {
  let comp: PermissionGroupDeleteDialog;
  let fixture: ComponentFixture<PermissionGroupDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PermissionGroupDeleteDialog);
