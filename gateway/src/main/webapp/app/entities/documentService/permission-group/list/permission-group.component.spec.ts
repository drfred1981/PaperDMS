...
import { sampleWithRequiredData } from '../permission-group.test-samples';
...
describe('PermissionGroup Management Component', () => {
  let comp: PermissionGroupComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PermissionGroupComponent, '')
      .compileComponents();
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.permissionGroups()[0]).toEqual(expect.objectContaining({ id: 20701 }));
  });

  describe('trackId', () => {
    it('should forward to permissionGroupService', () => {
      const entity = { id: 20701 };
      jest.spyOn(service, 'getPermissionGroupIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPermissionGroupIdentifier).toHaveBeenCalledWith(entity);
