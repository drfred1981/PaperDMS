...
import { DocumentSimilarityDeleteDialog } from './document-similarity-delete-dialog';

describe('DocumentSimilarity Management Delete Component', () => {
  let comp: DocumentSimilarityDeleteDialog;
  let fixture: ComponentFixture<DocumentSimilarityDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentSimilarityDeleteDialog);
