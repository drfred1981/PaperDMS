...
import { SimilarityClusterDeleteDialog } from './similarity-cluster-delete-dialog';

describe('SimilarityCluster Management Delete Component', () => {
  let comp: SimilarityClusterDeleteDialog;
  let fixture: ComponentFixture<SimilarityClusterDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SimilarityClusterDeleteDialog);
