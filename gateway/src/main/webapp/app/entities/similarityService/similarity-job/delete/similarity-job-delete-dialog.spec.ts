...
import { SimilarityJobDeleteDialog } from './similarity-job-delete-dialog';

describe('SimilarityJob Management Delete Component', () => {
  let comp: SimilarityJobDeleteDialog;
  let fixture: ComponentFixture<SimilarityJobDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SimilarityJobDeleteDialog);
