...
import { CorrespondentDeleteDialog } from './correspondent-delete-dialog';

describe('Correspondent Management Delete Component', () => {
  let comp: CorrespondentDeleteDialog;
  let fixture: ComponentFixture<CorrespondentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CorrespondentDeleteDialog);
