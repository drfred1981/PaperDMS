...
import { AiCacheDeleteDialog } from './ai-cache-delete-dialog';

describe('AiCache Management Delete Component', () => {
  let comp: AiCacheDeleteDialog;
  let fixture: ComponentFixture<AiCacheDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AiCacheDeleteDialog);
