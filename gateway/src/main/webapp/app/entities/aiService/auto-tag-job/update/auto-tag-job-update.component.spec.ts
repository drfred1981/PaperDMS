...
import { AutoTagJobUpdateComponent } from './auto-tag-job-update.component';

describe('AutoTagJob Management Update Component', () => {
  let comp: AutoTagJobUpdateComponent;
  let fixture: ComponentFixture<AutoTagJobUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [AutoTagJobUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(AutoTagJobUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(AutoTagJobUpdateComponent);
