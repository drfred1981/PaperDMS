...
import { TagPredictionDeleteDialog } from './tag-prediction-delete-dialog';

describe('TagPrediction Management Delete Component', () => {
  let comp: TagPredictionDeleteDialog;
  let fixture: ComponentFixture<TagPredictionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TagPredictionDeleteDialog);
