...
import { sampleWithRequiredData } from '../archive-job.test-samples';
import { ArchiveJobService } from '../service/archive-job.service';

import { ArchiveJob } from './archive-job';

describe('ArchiveJob Management Component', () => {
  let comp: ArchiveJob;
  let fixture: ComponentFixture<ArchiveJob>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ArchiveJob);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.archiveJobs()[0]).toEqual(expect.objectContaining({ id: 16105 }));
  });

  describe('trackId', () => {
    it('should forward to archiveJobService', () => {
      const entity = { id: 16105 };
      jest.spyOn(service, 'getArchiveJobIdentifier');
      const id = comp.trackId(entity);
      expect(service.getArchiveJobIdentifier).toHaveBeenCalledWith(entity);
