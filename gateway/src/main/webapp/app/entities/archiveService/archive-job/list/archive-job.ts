...
export class ArchiveJob implements OnInit {
  ...
  delete(archiveJob: IArchiveJob): void {
    const modalRef = this.modalService.open(ArchiveJobDeleteDialog, { size: 'lg', backdrop: 'static' });
