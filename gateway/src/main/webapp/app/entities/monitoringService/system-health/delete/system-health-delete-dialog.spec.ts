...
import { SystemHealthDeleteDialog } from './system-health-delete-dialog';

describe('SystemHealth Management Delete Component', () => {
  let comp: SystemHealthDeleteDialog;
  let fixture: ComponentFixture<SystemHealthDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SystemHealthDeleteDialog);
