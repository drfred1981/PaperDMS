...
import { MaintenanceTaskUpdate } from './maintenance-task-update';

describe('MaintenanceTask Management Update Component', () => {
  let comp: MaintenanceTaskUpdate;
  let fixture: ComponentFixture<MaintenanceTaskUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(MaintenanceTaskUpdate);
