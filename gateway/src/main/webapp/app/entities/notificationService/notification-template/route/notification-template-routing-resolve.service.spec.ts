...
import notificationTemplateResolve from './notification-template-routing-resolve.service';

describe('NotificationTemplate routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: NotificationTemplateService;
  let resultNotificationTemplate: INotificationTemplate | null | undefined;
  ...
  describe('resolve', () => {
    it('should return INotificationTemplate returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        notificationTemplateResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultNotificationTemplate).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<INotificationTemplate>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
