...
import { NotificationTemplateDeleteDialog } from './notification-template-delete-dialog';

describe('NotificationTemplate Management Delete Component', () => {
  let comp: NotificationTemplateDeleteDialog;
  let fixture: ComponentFixture<NotificationTemplateDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(NotificationTemplateDeleteDialog);
