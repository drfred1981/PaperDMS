...
import { sampleWithRequiredData } from '../notification-template.test-samples';
...
describe('NotificationTemplate Management Component', () => {
  let comp: NotificationTemplate;
  let fixture: ComponentFixture<NotificationTemplate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(NotificationTemplate);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.notificationTemplates()[0]).toEqual(expect.objectContaining({ id: 25253 }));
  });

  describe('trackId', () => {
    it('should forward to notificationTemplateService', () => {
      const entity = { id: 25253 };
      jest.spyOn(service, 'getNotificationTemplateIdentifier');
      const id = comp.trackId(entity);
      expect(service.getNotificationTemplateIdentifier).toHaveBeenCalledWith(entity);
