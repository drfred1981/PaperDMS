...
@Component({
  ...
  templateUrl: './webhook-subscription-update.component.html',
  imports: [SharedModule, FormsModule, ReactiveFormsModule],
})
export class WebhookSubscriptionUpdateComponent implements OnInit {
  isSaving = false;
  ...
  protected subscribeToSaveResponse(result: Observable<HttpResponse<IWebhookSubscription>>): void {
