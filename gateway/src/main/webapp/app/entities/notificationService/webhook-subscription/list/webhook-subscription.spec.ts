...
import { sampleWithRequiredData } from '../webhook-subscription.test-samples';

import { WebhookSubscription } from './webhook-subscription';

describe('WebhookSubscription Management Component', () => {
  let comp: WebhookSubscription;
  let fixture: ComponentFixture<WebhookSubscription>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WebhookSubscription);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.webhookSubscriptions()[0]).toEqual(expect.objectContaining({ id: 28283 }));
  });

  describe('trackId', () => {
    it('should forward to webhookSubscriptionService', () => {
      const entity = { id: 28283 };
      jest.spyOn(service, 'getWebhookSubscriptionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getWebhookSubscriptionIdentifier).toHaveBeenCalledWith(entity);
