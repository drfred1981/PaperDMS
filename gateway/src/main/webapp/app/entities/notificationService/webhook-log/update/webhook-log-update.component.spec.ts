...
import { WebhookLogUpdateComponent } from './webhook-log-update.component';

describe('WebhookLog Management Update Component', () => {
  let comp: WebhookLogUpdateComponent;
  let fixture: ComponentFixture<WebhookLogUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [WebhookLogUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(WebhookLogUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(WebhookLogUpdateComponent);
  ...
  describe('ngOnInit', () => {
    it('should call WebhookSubscription query and add missing value', () => {
      ...
      expect(webhookSubscriptionService.addWebhookSubscriptionToCollectionIfMissing).toHaveBeenCalledWith(
        ...
        ...additionalWebhookSubscriptions.map(expect.objectContaining),
      );
