...
@Component({
  ...
  templateUrl: './webhook-log-update.component.html',
  imports: [SharedModule, FormsModule, ReactiveFormsModule],
})
export class WebhookLogUpdateComponent implements OnInit {
  isSaving = false;
  webhookLog: IWebhookLog | null = null;

  webhookSubscriptionsSharedCollection: IWebhookSubscription[] = [];
  ...
  protected loadRelationshipsOptions(): void {
    this.webhookSubscriptionService
      ...
      .subscribe((webhookSubscriptions: IWebhookSubscription[]) => (this.webhookSubscriptionsSharedCollection = webhookSubscriptions));
  }
}
