...
import emailAttachmentResolve from './email-attachment-routing-resolve.service';
...
describe('EmailAttachment routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IEmailAttachment returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          emailAttachmentResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
