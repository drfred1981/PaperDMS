...
describe('EmailAttachment Management Delete Component', () => {
  let comp: EmailAttachmentDeleteDialog;
  let fixture: ComponentFixture<EmailAttachmentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmailAttachmentDeleteDialog);
