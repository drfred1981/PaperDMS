...
import { sampleWithRequiredData } from '../email-attachment.test-samples';
import { EmailAttachmentService } from '../service/email-attachment.service';

import { EmailAttachment } from './email-attachment';

describe('EmailAttachment Management Component', () => {
  let comp: EmailAttachment;
  let fixture: ComponentFixture<EmailAttachment>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmailAttachment);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.emailAttachments()[0]).toEqual(expect.objectContaining({ id: 28685 }));
  });

  describe('trackId', () => {
    it('should forward to emailAttachmentService', () => {
      const entity = { id: 28685 };
