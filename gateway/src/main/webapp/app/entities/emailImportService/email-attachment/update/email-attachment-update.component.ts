...
export class EmailAttachmentUpdateComponent implements OnInit {
  ...
  emailImportsSharedCollection: IEmailImport[] = [];
  ...
  protected updateForm(emailAttachment: IEmailAttachment): void {
    ...
    this.emailImportsSharedCollection = this.emailImportService.addEmailImportToCollectionIfMissing<IEmailImport>(
  ...
  protected loadRelationshipsOptions(): void {
    this.emailImportService
      ...
      .subscribe((emailImports: IEmailImport[]) => (this.emailImportsSharedCollection = emailImports));
  }
}
