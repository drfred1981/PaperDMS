...
import { sampleWithRequiredData } from '../email-import.test-samples';
import { EmailImportService } from '../service/email-import.service';

import { EmailImport } from './email-import';

describe('EmailImport Management Component', () => {
  let comp: EmailImport;
  let fixture: ComponentFixture<EmailImport>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmailImport);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.emailImports()[0]).toEqual(expect.objectContaining({ id: 3064 }));
  });

  describe('trackId', () => {
    it('should forward to emailImportService', () => {
      const entity = { id: 3064 };
      jest.spyOn(service, 'getEmailImportIdentifier');
      const id = comp.trackId(entity);
      expect(service.getEmailImportIdentifier).toHaveBeenCalledWith(entity);
