...
import { EmailImportUpdate } from './email-import-update';

describe('EmailImport Management Update Component', () => {
  let comp: EmailImportUpdate;
  let fixture: ComponentFixture<EmailImportUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EmailImportUpdate);
