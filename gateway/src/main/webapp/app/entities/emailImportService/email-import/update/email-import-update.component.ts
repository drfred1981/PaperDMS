...
@Component({
  ...
  templateUrl: './email-import-update.component.html',
  imports: [SharedModule, FormsModule, ReactiveFormsModule],
})
export class EmailImportUpdateComponent implements OnInit {
  isSaving = false;
  emailImport: IEmailImport | null = null;
  importStatusValues = Object.keys(ImportStatus);

  importRulesSharedCollection: IImportRule[] = [];
  ...
  protected updateForm(emailImport: IEmailImport): void {
    ...
    this.importRulesSharedCollection = this.importRuleService.addImportRuleToCollectionIfMissing<IImportRule>(
      this.importRulesSharedCollection,
      emailImport.appliedRule,
    );
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.importRuleService
      ...
      .subscribe((importRules: IImportRule[]) => (this.importRulesSharedCollection = importRules));
  }
}
