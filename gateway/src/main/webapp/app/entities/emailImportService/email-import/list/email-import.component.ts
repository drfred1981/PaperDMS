...
import { EmailImportDeleteDialogComponent } from '../delete/email-import-delete-dialog.component';
...
export class EmailImportComponent implements OnInit {
  ...
  delete(emailImport: IEmailImport): void {
    const modalRef = this.modalService.open(EmailImportDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
