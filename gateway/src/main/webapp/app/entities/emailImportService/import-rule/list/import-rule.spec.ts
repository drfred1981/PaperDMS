...
import { sampleWithRequiredData } from '../import-rule.test-samples';
import { ImportRuleService } from '../service/import-rule.service';

import { ImportRule } from './import-rule';

describe('ImportRule Management Component', () => {
  let comp: ImportRule;
  let fixture: ComponentFixture<ImportRule>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ImportRule);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.importRules()[0]).toEqual(expect.objectContaining({ id: 3928 }));
  });

  describe('trackId', () => {
    it('should forward to importRuleService', () => {
      const entity = { id: 3928 };
      jest.spyOn(service, 'getImportRuleIdentifier');
      const id = comp.trackId(entity);
      expect(service.getImportRuleIdentifier).toHaveBeenCalledWith(entity);
