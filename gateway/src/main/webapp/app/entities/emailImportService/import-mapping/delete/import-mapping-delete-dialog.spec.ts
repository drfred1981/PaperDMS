...
import { ImportMappingDeleteDialog } from './import-mapping-delete-dialog';

describe('ImportMapping Management Delete Component', () => {
  let comp: ImportMappingDeleteDialog;
  let fixture: ComponentFixture<ImportMappingDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ImportMappingDeleteDialog);
