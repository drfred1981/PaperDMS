...
import { ImportMappingUpdateComponent } from './import-mapping-update.component';

describe('ImportMapping Management Update Component', () => {
  let comp: ImportMappingUpdateComponent;
  let fixture: ComponentFixture<ImportMappingUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ImportMappingUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(ImportMappingUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(ImportMappingUpdateComponent);
