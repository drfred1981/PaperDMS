...
import contractResolve from './contract-routing-resolve.service';
...
describe('Contract routing resolve service', () => {
  ...
  describe('resolve', () => {
    it('should return IContract returned by find', async () => {
      // GIVEN
      ...
      await new Promise<void>(resolve => {
        TestBed.runInInjectionContext(() => {
          contractResolve(mockActivatedRouteSnapshot).subscribe({
            next(result) {
              // THEN
