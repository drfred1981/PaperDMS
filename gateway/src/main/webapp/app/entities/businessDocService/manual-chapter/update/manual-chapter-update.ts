...
@Component({
  ...
  templateUrl: './manual-chapter-update.html',
  imports: [SharedModule, ReactiveFormsModule],
})
export class ManualChapterUpdate implements OnInit {
  isSaving = false;
  manualChapter: IManualChapter | null = null;

  manualChaptersSharedCollection = signal<IManualChapter[]>([]);
  manualsSharedCollection = signal<IManual[]>([]);
  ...
  protected updateForm(manualChapter: IManualChapter): void {
    ...
    this.manualChaptersSharedCollection.set(
    ...
    this.manualsSharedCollection.set(
      this.manualService.addManualToCollectionIfMissing<IManual>(this.manualsSharedCollection(), manualChapter.manual),
    );
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.manualChapterService
      ...
      .subscribe((manualChapters: IManualChapter[]) => this.manualChaptersSharedCollection.set(manualChapters));
    ...
    this.manualService
      ...
      .subscribe((manuals: IManual[]) => this.manualsSharedCollection.set(manuals));
  }
}
