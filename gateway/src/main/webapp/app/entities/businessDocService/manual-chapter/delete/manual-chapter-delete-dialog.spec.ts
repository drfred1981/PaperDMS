...
import { ManualChapterDeleteDialog } from './manual-chapter-delete-dialog';

describe('ManualChapter Management Delete Component', () => {
  let comp: ManualChapterDeleteDialog;
  let fixture: ComponentFixture<ManualChapterDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ManualChapterDeleteDialog);
