...
import { ManualChapterUpdate } from './manual-chapter-update';

describe('ManualChapter Management Update Component', () => {
  let comp: ManualChapterUpdate;
  let fixture: ComponentFixture<ManualChapterUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ManualChapterUpdate);
  ...
  describe('ngOnInit', () => {
    it('should call ManualChapter query and add missing value', () => {
      ...
      expect(manualChapterService.addManualChapterToCollectionIfMissing).toHaveBeenCalledWith(
        ...
        ...additionalManualChapters.map(i => expect.objectContaining(i) as typeof i),
      );
    ...
    it('should call Manual query and add missing value', () => {
      ...
      expect(manualService.addManualToCollectionIfMissing).toHaveBeenCalledWith(
        manualCollection,
        ...additionalManuals.map(i => expect.objectContaining(i) as typeof i),
      );
