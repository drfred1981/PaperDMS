...
export class ManualChapterService {
  ...
  update(manualChapter: IManualChapter): Observable<EntityResponseType> {
    return this.http.put<IManualChapter>(
      `${this.resourceUrl}/${encodeURIComponent(this.getManualChapterIdentifier(manualChapter))}`,
      manualChapter,
      { observe: 'response' },
    );
  }
  ...
  partialUpdate(manualChapter: PartialUpdateManualChapter): Observable<EntityResponseType> {
    return this.http.patch<IManualChapter>(
      `${this.resourceUrl}/${encodeURIComponent(this.getManualChapterIdentifier(manualChapter))}`,
      manualChapter,
      { observe: 'response' },
    );
  ...
  find(id: number): Observable<EntityResponseType> {
    return this.http.get<IManualChapter>(`${this.resourceUrl}/${encodeURIComponent(id)}`, { observe: 'response' });
  }
