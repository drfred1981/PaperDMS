...
import { sampleWithRequiredData } from '../manual.test-samples';
...
describe('Manual Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.manuals()[0]).toEqual(expect.objectContaining({ id: 16259 }));
  });

  describe('trackId', () => {
    it('should forward to manualService', () => {
      const entity = { id: 16259 };
      jest.spyOn(service, 'getManualIdentifier');
      const id = comp.trackId(entity);
      expect(service.getManualIdentifier).toHaveBeenCalledWith(entity);
