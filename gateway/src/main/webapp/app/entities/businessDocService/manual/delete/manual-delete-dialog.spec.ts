...
import { ManualDeleteDialog } from './manual-delete-dialog';

describe('Manual Management Delete Component', () => {
  let comp: ManualDeleteDialog;
  let fixture: ComponentFixture<ManualDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ManualDeleteDialog);
