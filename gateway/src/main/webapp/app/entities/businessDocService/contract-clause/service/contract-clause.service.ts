...
export class ContractClauseService {
  ...
  update(contractClause: IContractClause): Observable<EntityResponseType> {
    return this.http.put<IContractClause>(
      `${this.resourceUrl}/${encodeURIComponent(this.getContractClauseIdentifier(contractClause))}`,
      contractClause,
      { observe: 'response' },
    );
  }
  ...
  partialUpdate(contractClause: PartialUpdateContractClause): Observable<EntityResponseType> {
    return this.http.patch<IContractClause>(
      `${this.resourceUrl}/${encodeURIComponent(this.getContractClauseIdentifier(contractClause))}`,
      contractClause,
      { observe: 'response' },
    );
  ...
  find(id: number): Observable<EntityResponseType> {
    return this.http.get<IContractClause>(`${this.resourceUrl}/${encodeURIComponent(id)}`, { observe: 'response' });
  }
