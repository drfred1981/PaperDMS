...
import { ContractClauseUpdateComponent } from './contract-clause-update.component';

describe('ContractClause Management Update Component', () => {
  let comp: ContractClauseUpdateComponent;
  let fixture: ComponentFixture<ContractClauseUpdateComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ContractClauseUpdateComponent],
      providers: [
        provideHttpClient(),
        FormBuilder,
        {
      ...
      .overrideTemplate(ContractClauseUpdateComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(ContractClauseUpdateComponent);
