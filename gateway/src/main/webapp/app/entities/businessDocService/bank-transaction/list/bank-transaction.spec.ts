...
import { sampleWithRequiredData } from '../bank-transaction.test-samples';
import { BankTransactionService } from '../service/bank-transaction.service';

import { BankTransaction } from './bank-transaction';

describe('BankTransaction Management Component', () => {
  let comp: BankTransaction;
  let fixture: ComponentFixture<BankTransaction>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BankTransaction);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.bankTransactions()[0]).toEqual(expect.objectContaining({ id: 28516 }));
  });

  describe('trackId', () => {
    it('should forward to bankTransactionService', () => {
      const entity = { id: 28516 };
