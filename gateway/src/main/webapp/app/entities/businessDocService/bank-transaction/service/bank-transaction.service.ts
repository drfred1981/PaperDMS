...
export class BankTransactionService {
  ...
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/bank-transactions', 'businessdocservice');
  ...
  protected convertDateFromClient<T extends IBankTransaction | NewBankTransaction | PartialUpdateBankTransaction>(
    ...
    return {
      ...bankTransaction,
      transactionDate: bankTransaction.transactionDate?.format(DATE_FORMAT) ?? null,
    };
  }
