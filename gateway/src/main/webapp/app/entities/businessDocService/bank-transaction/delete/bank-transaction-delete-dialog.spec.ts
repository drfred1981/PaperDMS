...
describe('BankTransaction Management Delete Component', () => {
  let comp: BankTransactionDeleteDialog;
  let fixture: ComponentFixture<BankTransactionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BankTransactionDeleteDialog);
