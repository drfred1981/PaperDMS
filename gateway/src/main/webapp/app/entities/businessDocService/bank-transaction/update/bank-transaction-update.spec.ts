...
describe('BankTransaction Management Update Component', () => {
  let comp: BankTransactionUpdate;
  let fixture: ComponentFixture<BankTransactionUpdate>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BankTransactionUpdate);
  ...
  describe('ngOnInit', () => {
    it('should call BankStatement query and add missing value', () => {
      ...
      expect(bankStatementService.addBankStatementToCollectionIfMissing).toHaveBeenCalledWith(
        ...
        ...additionalBankStatements.map(i => expect.objectContaining(i) as typeof i),
      );
