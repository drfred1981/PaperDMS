...
describe('InvoiceLine Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.invoiceLines()[0]).toEqual(expect.objectContaining({ id: 8710 }));
  });

  describe('trackId', () => {
    it('should forward to invoiceLineService', () => {
      const entity = { id: 8710 };
      jest.spyOn(service, 'getInvoiceLineIdentifier');
      const id = comp.trackId(entity);
      expect(service.getInvoiceLineIdentifier).toHaveBeenCalledWith(entity);
