...
@Component({
  ...
  templateUrl: './invoice-line-update.html',
  imports: [SharedModule, ReactiveFormsModule],
})
export class InvoiceLineUpdate implements OnInit {
  isSaving = false;
  invoiceLine: IInvoiceLine | null = null;

  invoicesSharedCollection = signal<IInvoice[]>([]);
  ...
  protected updateForm(invoiceLine: IInvoiceLine): void {
    ...
    this.invoicesSharedCollection.set(
      this.invoiceService.addInvoiceToCollectionIfMissing<IInvoice>(this.invoicesSharedCollection(), invoiceLine.invoice),
    );
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.invoiceService
      ...
      .subscribe((invoices: IInvoice[]) => this.invoicesSharedCollection.set(invoices));
  }
}
