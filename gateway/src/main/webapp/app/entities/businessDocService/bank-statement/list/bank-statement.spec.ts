...
import { sampleWithRequiredData } from '../bank-statement.test-samples';
import { BankStatementService } from '../service/bank-statement.service';

import { BankStatement } from './bank-statement';

describe('BankStatement Management Component', () => {
  let comp: BankStatement;
  let fixture: ComponentFixture<BankStatement>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(BankStatement);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.bankStatements()[0]).toEqual(expect.objectContaining({ id: 32402 }));
  });

  describe('trackId', () => {
    it('should forward to bankStatementService', () => {
      const entity = { id: 32402 };
      jest.spyOn(service, 'getBankStatementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getBankStatementIdentifier).toHaveBeenCalledWith(entity);
