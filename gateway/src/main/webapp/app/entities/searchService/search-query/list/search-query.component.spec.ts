...
import { sampleWithRequiredData } from '../search-query.test-samples';
...
describe('SearchQuery Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.searchQueries()[0]).toEqual(expect.objectContaining({ id: 14684 }));
  });

  describe('trackId', () => {
    it('should forward to searchQueryService', () => {
      const entity = { id: 14684 };
      jest.spyOn(service, 'getSearchQueryIdentifier');
      const id = comp.trackId(entity);
      expect(service.getSearchQueryIdentifier).toHaveBeenCalledWith(entity);
