...
import { SearchIndexDeleteDialog } from './search-index-delete-dialog';

describe('SearchIndex Management Delete Component', () => {
  let comp: SearchIndexDeleteDialog;
  let fixture: ComponentFixture<SearchIndexDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SearchIndexDeleteDialog);
