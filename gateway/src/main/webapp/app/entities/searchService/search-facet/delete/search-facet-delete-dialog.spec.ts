...
import { SearchFacetDeleteDialog } from './search-facet-delete-dialog';

describe('SearchFacet Management Delete Component', () => {
  let comp: SearchFacetDeleteDialog;
  let fixture: ComponentFixture<SearchFacetDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SearchFacetDeleteDialog);
