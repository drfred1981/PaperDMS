...
@Component({
  ...
  templateUrl: './search-facet-update.html',
  imports: [SharedModule, ReactiveFormsModule],
})
export class SearchFacetUpdate implements OnInit {
  isSaving = false;
  searchFacet: ISearchFacet | null = null;
  facetTypeValues = Object.keys(FacetType);

  searchQueriesSharedCollection = signal<ISearchQuery[]>([]);
  ...
  protected updateForm(searchFacet: ISearchFacet): void {
    ...
    this.searchQueriesSharedCollection.set(
      this.searchQueryService.addSearchQueryToCollectionIfMissing<ISearchQuery>(
  ...
  protected loadRelationshipsOptions(): void {
    this.searchQueryService
      ...
      .subscribe((searchQueries: ISearchQuery[]) => this.searchQueriesSharedCollection.set(searchQueries));
  }
}
