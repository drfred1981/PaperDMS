...
import { ScanBatchDeleteDialog } from './scan-batch-delete-dialog';

describe('ScanBatch Management Delete Component', () => {
  let comp: ScanBatchDeleteDialog;
  let fixture: ComponentFixture<ScanBatchDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ScanBatchDeleteDialog);
