...
public class DocumentProcessResource {
    ...
    public DocumentProcessResource(DocumentProcessService documentProcessService, DocumentProcessRepository documentProcessRepository) {
    ...
    public ResponseEntity<List<DocumentProcessDTO>> getAllDocumentProcesses(
        ...
        LOG.debug("REST request to get a page of DocumentProcesses");
        Page<DocumentProcessDTO> page = documentProcessService.findAll(pageable);
