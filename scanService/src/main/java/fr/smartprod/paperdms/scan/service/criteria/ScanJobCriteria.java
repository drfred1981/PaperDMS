...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.scan.domain.ScanJob}
 * entity. This class is used in
 * {@link fr.smartprod.paperdms.scan.web.rest.ScanJobResource} to receive all
...
public class ScanJobCriteria implements Serializable, Criteria {
	...
	public boolean equals(Object o) {
		...
		return (Objects.equals(id, that.id) && Objects.equals(name, that.name)
				&& Objects.equals(scannerConfigId, that.scannerConfigId) && Objects.equals(batchId, that.batchId)
				&& Objects.equals(documentTypeId, that.documentTypeId) && Objects.equals(folderId, that.folderId)
				&& Objects.equals(pageCount, that.pageCount) && Objects.equals(status, that.status)
				&& Objects.equals(colorMode, that.colorMode) && Objects.equals(resolution, that.resolution)
				&& Objects.equals(fileFormat, that.fileFormat) && Objects.equals(startDate, that.startDate)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, name, scannerConfigId, batchId, documentTypeId, folderId, pageCount, status, colorMode,
				resolution, fileFormat, startDate, endDate, createdBy, createdDate, scannerConfigId, batchId, distinct);
	}

	// prettier-ignore
	@Override
	public String toString() {
		return "ScanJobCriteria{" + optionalId().map(f -> "id=" + f + ", ").orElse("")
