...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.reporting.domain.ReportingScheduledReport} entity. This class is used
 * in {@link fr.smartprod.paperdms.reporting.web.rest.ReportingScheduledReportResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /reporting-scheduled-reports?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ReportingScheduledReportCriteria implements Serializable, Criteria {
    ...
    private LongFilter reportsExecutionsId;

    private Boolean distinct;

    public ReportingScheduledReportCriteria() {}

    public ReportingScheduledReportCriteria(ReportingScheduledReportCriteria other) {
        ...
        this.reportsExecutionsId = other.optionalReportsExecutionsId().map(LongFilter::copy).orElse(null);
        this.distinct = other.distinct;
    }

    @Override
    public ReportingScheduledReportCriteria copy() {
        return new ReportingScheduledReportCriteria(this);
    }
    ...
    public LongFilter getReportsExecutionsId() {
        return reportsExecutionsId;
    }

    public Optional<LongFilter> optionalReportsExecutionsId() {
        return Optional.ofNullable(reportsExecutionsId);
    }

    public LongFilter reportsExecutionsId() {
        if (reportsExecutionsId == null) {
            setReportsExecutionsId(new LongFilter());
        }
        return reportsExecutionsId;
    }

    public void setReportsExecutionsId(LongFilter reportsExecutionsId) {
        this.reportsExecutionsId = reportsExecutionsId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final ReportingScheduledReportCriteria that = (ReportingScheduledReportCriteria) o;
        return (
            ...
            Objects.equals(reportsExecutionsId, that.reportsExecutionsId) &&
    ...
    public String toString() {
        return "ReportingScheduledReportCriteria{" +
            ...
            optionalReportsExecutionsId().map(f -> "reportsExecutionsId=" + f + ", ").orElse("") +
