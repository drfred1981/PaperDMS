...
public class SimilarityJobTestSamples {
    ...
    public static SimilarityJob getSimilarityJobSample1() {
        return new SimilarityJob().id(1L).documentId(1L).matchesFound(1).createdBy("createdBy1");
    }

    public static SimilarityJob getSimilarityJobSample2() {
        return new SimilarityJob().id(2L).documentId(2L).matchesFound(2).createdBy("createdBy2");
    }
