...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.similarity.domain.SimilarityJob} entity. This class is used
 * in {@link fr.smartprod.paperdms.similarity.web.rest.SimilarityJobResource} to receive all the possible filtering options from
...
public class SimilarityJobCriteria implements Serializable, Criteria {
    ...
    private LongFilter similaritiesId;
    ...
    public SimilarityJobCriteria(SimilarityJobCriteria other) {
        ...
        this.similaritiesId = other.optionalSimilaritiesId().map(LongFilter::copy).orElse(null);
    ...
    public LongFilter getSimilaritiesId() {
        return similaritiesId;
    }

    public Optional<LongFilter> optionalSimilaritiesId() {
        return Optional.ofNullable(similaritiesId);
    }

    public LongFilter similaritiesId() {
        if (similaritiesId == null) {
            setSimilaritiesId(new LongFilter());
        }
        return similaritiesId;
    }

    public void setSimilaritiesId(LongFilter similaritiesId) {
        this.similaritiesId = similaritiesId;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            ...
            Objects.equals(similaritiesId, that.similaritiesId) &&
    ...
    public String toString() {
        return "SimilarityJobCriteria{" +
            ...
            optionalSimilaritiesId().map(f -> "similaritiesId=" + f + ", ").orElse("") +
