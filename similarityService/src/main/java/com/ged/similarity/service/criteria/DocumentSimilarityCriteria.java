...
/**
 * Criteria class for the {@link com.ged.similarity.domain.DocumentSimilarity} entity. This class is used
 * in {@link com.ged.similarity.web.rest.DocumentSimilarityResource} to receive all the possible filtering options from
