 ...
 * {@link fr.smartprod.paperdms.emailimport.domain.EmailImport} entity. This
 * class is used in
 * {@link fr.smartprod.paperdms.emailimport.web.rest.EmailImportResource} to
...
public class EmailImportCriteria implements Serializable, Criteria {
	...
	public boolean equals(Object o) {
		...
		return (Objects.equals(id, that.id) && Objects.equals(fromEmail, that.fromEmail)
				&& Objects.equals(toEmail, that.toEmail) && Objects.equals(subject, that.subject)
				&& Objects.equals(receivedDate, that.receivedDate) && Objects.equals(processedDate, that.processedDate)
				&& Objects.equals(status, that.status) && Objects.equals(folderId, that.folderId)
				...
				&& Objects.equals(appliedRuleId, that.appliedRuleId) && Objects.equals(distinct, that.distinct));
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, fromEmail, toEmail, subject, receivedDate, processedDate, status, folderId,
				documentTypeId, attachmentCount, documentsCreated, appliedRuleId, appliedRuleId, distinct);
	}

	// prettier-ignore
	@Override
	public String toString() {
		return "EmailImportCriteria{" + optionalId().map(f -> "id=" + f + ", ").orElse("")
