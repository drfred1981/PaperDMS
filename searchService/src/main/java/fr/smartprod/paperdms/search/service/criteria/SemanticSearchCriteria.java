...
/**
 * Criteria class for the {@link fr.smartprod.paperdms.search.domain.SemanticSearch} entity. This class is used
 * in {@link fr.smartprod.paperdms.search.web.rest.SemanticSearchResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /semantic-searches?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class SemanticSearchCriteria implements Serializable, Criteria {
    ...
    public SemanticSearchCriteria() {}

    public SemanticSearchCriteria(SemanticSearchCriteria other) {
    ...
    @Override
    public SemanticSearchCriteria copy() {
        return new SemanticSearchCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SemanticSearchCriteria that = (SemanticSearchCriteria) o;
        return (
