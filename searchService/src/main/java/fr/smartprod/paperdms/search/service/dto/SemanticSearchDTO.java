...
/**
 * A DTO for the {@link fr.smartprod.paperdms.search.domain.SemanticSearch} entity.
 */
...
public class SemanticSearchDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SemanticSearchDTO)) {
            return false;
        }

        SemanticSearchDTO semanticSearchDTO = (SemanticSearchDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, semanticSearchDTO.id);
    }
